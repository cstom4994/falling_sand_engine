...
local action_names = {
    "STOP", "SECTION", "ESC", "REL_EXT", "ALIGN", "REL_LG", "LABEL_LG",
...
local map_action = {}
for n, name in ipairs(action_names) do map_action[name] = n - 1 end
...
function _M.revdef(s) return map_reg_rev[s] or s end
...
local map_op = {
    ...
    pkhbt_3 = "e6800010DNM",
    pkhbt_4 = "e6800010DNMv", -- v6
    pkhtb_3 = "e6800050DNM",
    pkhtb_4 = "e6800050DNMv", -- v6
    sxtab_3 = "e6a00070DNM",
    sxtab_4 = "e6a00070DNMv", -- v6
    sxtab16_3 = "e6800070DNM",
    sxtab16_4 = "e6800070DNMv", -- v6
    sxtah_3 = "e6b00070DNM",
    sxtah_4 = "e6b00070DNMv", -- v6
    sxtb_2 = "e6af0070DM",
    sxtb_3 = "e6af0070DMv", -- v6
    sxtb16_2 = "e68f0070DM",
    sxtb16_3 = "e68f0070DMv", -- v6
    sxth_2 = "e6bf0070DM",
    sxth_3 = "e6bf0070DMv", -- v6
    uxtab_3 = "e6e00070DNM",
    uxtab_4 = "e6e00070DNMv", -- v6
    uxtab16_3 = "e6c00070DNM",
    uxtab16_4 = "e6c00070DNMv", -- v6
    uxtah_3 = "e6f00070DNM",
    uxtah_4 = "e6f00070DNMv", -- v6
    uxtb_2 = "e6ef0070DM",
    uxtb_3 = "e6ef0070DMv", -- v6
    uxtb16_2 = "e6cf0070DM",
    uxtb16_3 = "e6cf0070DMv", -- v6
    uxth_2 = "e6ff0070DM",
    uxth_3 = "e6ff0070DMv", -- v6
    ...
    ssat_3 = "e6a00010DXM",
    ssat_4 = "e6a00010DXMp", -- v6
    usat_3 = "e6e00010DXM",
    usat_4 = "e6e00010DXMp", -- v6
    ...
    ldrh_3 = "e01000b0DL",
    ldrd_2 = "e00000d0DL",
    ldrd_3 = "e00000d0DL", -- v5TE
    ldrsb_2 = "e01000d0DL",
    ldrsb_3 = "e01000d0DL",
    strd_2 = "e00000f0DL",
    strd_3 = "e00000f0DL", -- v5TE
    ldrsh_2 = "e01000f0DL",
    ldrsh_3 = "e01000f0DL",
...
do
    ...
    for k, v in pairs(t) do map_op[k] = v end
end
...
local function parse_imm(imm, bits, shift, scale, signed)
    ...
    if n then
        if n % 2 ^ scale == 0 then
            ...
            if signed then
                if n >= 0 then
                    ...
                    if n >= -(2 ^ (bits - 1)) - 1 then
                        return (n + 2 ^ bits) * 2 ^ shift
                    end
                end
            else
                if n >= 0 and n <= 2 ^ bits - 1 then
                    return n * 2 ^ shift
                end
            end
        end
        ...
        waction("IMM",
                (signed and 32768 or 0) + scale * 1024 + bits * 32 + shift, imm)
        return 0
    end
end
...
local function parse_imm12(imm)
    ...
    if n then
        local m = n
        for i = 0, -15, -1 do
            if m >= 0 and m <= 255 and n % 1 == 0 then
                return m + (i % 16) * 256
            end
            local t = m % 4
            m = (m - t) / 4 + t * 2 ^ 30
...
local function parse_label(label, def)
    ...
    if prefix == "=>" then return "PC", 0, sub(label, 3) end
    -- ->name (global label reference)
    if prefix == "->" then return "LG", map_global[sub(label, 3)] end
    if def then
        -- [1-9] (local label definition)
        if match(label, "^[1-9]$") then return "LG", 10 + tonumber(label) end
    else
        ...
        if extname then return "EXT", map_extern[extname] end
    end
    ...
    if not p1 then
        if not p2 then
            ...
            if reg and tailr ~= "" then
                ...
                if tp then
                    waction(ext and "IMML8" or "IMML12",
                            32768 + 32 * (ext and 8 or 12),
                            format(tp.ctypefmt, tailr))
                    return op + d * 65536 + 0x01000000 +
                               (ext and 0x00400000 or 0)
                end
            end
        end
    ...
    if p2 then
        ...
        if p2 ~= "" then
            ...
            if imm then
                ...
                op = op + m + (neg and 0 or 0x00800000) +
                         (ext and 0 or 0x02000000)
                if p3 ~= "" then
...
map_op[".template__"] = function(params, template, nparams)
    ...
    for p in gmatch(sub(template, 9), ".") do
        if p == "D" then
            op = op + parse_gpr(params[n]) * 4096;
            n = n + 1
        elseif p == "N" then
            op = op + parse_gpr(params[n]) * 65536;
            n = n + 1
        elseif p == "S" then
            op = op + parse_gpr(params[n]) * 256;
            n = n + 1
        elseif p == "M" then
        ...
        elseif p == "P" then
            ...
            n = n + 1
        elseif p == "p" then
            op = op + parse_shift(params[n], true);
            n = n + 1
        elseif p == "L" then
        ...
        elseif p == "n" then
            ...
            n = n + 1
        elseif p == "R" then
            op = op + parse_reglist(params[n]);
            n = n + 1
        elseif p == "W" then
            op = op + parse_imm16(params[n]);
            n = n + 1
        elseif p == "v" then
            op = op + parse_imm(params[n], 5, 7, 0, false);
            n = n + 1
        elseif p == "w" then
            local imm = match(params[n], "^#(.*)$")
            if imm then
        ...
        elseif p == "X" then
            ...
            n = n + 1
        elseif p == "K" then
            local imm = tonumber(match(params[n], "^#(.*)$"));
            n = n + 1
            ...
            op = op + (imm - t) * 16 + t
        elseif p == "T" then
            op = op + parse_imm(params[n], 24, 0, 0, false);
            n = n + 1
        elseif p == "s" then
            -- Ignored.
        else
...
function _M.setup(arch, opt) g_arch, g_opt = arch, opt end
