...
using OpNotes = std::tuple<Ts...>;
}  // namespace Annotations

inline namespace Shared {
enum class Statics { Excluded = 0, Included = 1, Only = 2 };

template <bool IsStatic, Statics statics>
struct matches_statics {
    constexpr static bool value = statics == Statics::Included || (statics == Statics::Excluded && !IsStatic) || (statics == Statics::Only && IsStatic);
};
...
static constexpr size_t IgnoredFieldCount() {
    ...
    class_t<Object>::ForEachField([&](auto& field) {
        ...
        if constexpr ((Field::template HasAnnotation<json::IgnoreType> || Field::IsFunction) && matches_statics<Field::IsStatic, statics>::value) count++;
    });
    return count;
}
...
static constexpr bool HasFields() {
    constexpr bool MatchesStaticsExcluded = statics == Statics::Excluded && class_t<Object>::TotalFields - class_t<Object>::TotalStaticFields - IgnoredFieldCount<statics, Object>() > 0;
    constexpr bool MatchesStaticsIncluded = statics == Statics::Included && class_t<Object>::TotalFields - IgnoredFieldCount<statics, Object>() > 0;
    constexpr bool MatchesStaticsOnly = statics == Statics::Only && class_t<Object>::TotalStaticFields - IgnoredFieldCount<statics, Object>() > 0;
    ...
    if constexpr (MatchesStaticsExcluded || MatchesStaticsIncluded || MatchesStaticsOnly)
        ...
        supers_t<Object>::ForEach([&](auto superInfo) {
            ...
            if constexpr (HasFields<statics, Super>()) hasFields = true;
        });
        return hasFields;
    }
}
...
static inline std::string simplifyTypeStr(const std::string& superTypeStr) {
    ...
    if (rawSimpleTypeStr.find("struct ", 0) != std::string::npos) rawSimpleTypeStr.erase(0, strlen("struct "));
    if (rawSimpleTypeStr.find("class ", 0) != std::string::npos) rawSimpleTypeStr.erase(0, strlen("class "));
...
static inline std::string fieldClusterToJsonFieldName() { return std::string("____fieldCluster"); }
}  // namespace TypeNames
};  // namespace Shared

inline namespace Generic {
struct JsonField {
    enum_t(Type, size_t, {Regular = 0, SuperClass = 1, FieldCluster = 2});
...
class Value {
public:
    enum_t(Type, uint8_t, {None, Null, Boolean, Number, String, Object, Array, NullArray, BoolArray, NumberArray, StringArray, ObjectArray, MixedArray, FieldCluster});
        ...
        static std::string getTypeStr(Value::Type type) {
            switch (type) {
                ...
                case Value::Type::Array:
                    return "Array";
                case Value::Type::BoolArray:
                    return "BoolArray";
                case Value::Type::NumberArray:
                    return "NumberArray";
                case Value::Type::StringArray:
                    return "StringArray";
                case Value::Type::ObjectArray:
                    return "ObjectArray";
                case Value::Type::MixedArray:
                    return "MixedArray";
            }
            return "Unknown";
        }
    ...
    public:
        ...
        static std::shared_ptr<Assigner> Make(Args&&... args) {
            return std::make_shared<Assigner>(std::move(std::make_unique<Value>(args...)));
        }
...
public:
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::Boolean, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::Boolean, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    template <size_t N>
    Number(const char (&value)[N]) : value(value, N) {}
    template <typename T>
    Number(const T& value) : value(std::to_string(value)) {}
    virtual ~Number() {}

    Number& operator=(const Value& other) {
        value = other.number();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::Number, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::Number, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    String& operator=(const Value& other) {
        value = other.string();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::String, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::String, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    Object& operator=(const Value& other) {
        value = other.object();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::Object, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::Object, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual void put(std::string fieldName, std::shared_ptr<Value> value) { this->value.insert_or_assign(fieldName, value); }
...
public:
    ...
    NullArray& operator=(const Value& other) {
        nullCount = other.nullArray();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::NullArray, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::NullArray, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    BoolArray& operator=(const Value& other) {
        values = other.boolArray();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::BoolArray, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::BoolArray, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    NumberArray& operator=(const Value& other) {
        values = other.numberArray();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::NumberArray, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::NumberArray, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    StringArray& operator=(const Value& other) {
        values = other.stringArray();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::StringArray, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::StringArray, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    ObjectArray& operator=(const Value& other) {
        values = other.objectArray();
        return *this;
    }
...
public:
    ...
    MixedArray& operator=(const Value& other) {
        values = other.mixedArray();
        return *this;
    }
    ...
    virtual std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() { throw TypeMismatch(Value::Type::MixedArray, Value::Type::ObjectArray, "objectArray"); }
    ...
    virtual const std::vector<std::map<std::string, std::shared_ptr<Value>>>& objectArray() const { throw TypeMismatch(Value::Type::MixedArray, Value::Type::ObjectArray, "objectArray"); }
...
public:
    ...
    FieldCluster& operator=(const Value& other) {
        object() = other.object();
        return *this;
    }
...
template <typename T>
struct is_non_primitive {
    static constexpr bool value = is_tuple<T>::value || is_pair<T>::value || is_iterable<T>::value || is_reflected<T>::value;
};
template <typename T>
struct is_non_primitive<const T> {
    static constexpr bool value = is_non_primitive<T>::value;
};
template <typename T>
struct is_non_primitive<T*> {
    static constexpr bool value = is_non_primitive<T>::value;
};
template <typename T>
struct is_non_primitive<T&> {
...
template <typename T>
struct is_non_primitive<std::unique_ptr<T>> {
    static constexpr bool value = is_non_primitive<T>::value;
};
template <typename T>
struct is_non_primitive<std::shared_ptr<T>> {
    static constexpr bool value = is_non_primitive<T>::value;
};
template <>
struct is_non_primitive<json::Generic::Object> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::NullArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::BoolArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::NumberArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::StringArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::ObjectArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::MixedArray> {
    static constexpr bool value = true;
};
template <>
struct is_non_primitive<json::Generic::FieldCluster> {
    static constexpr bool value = true;
};

template <size_t Index, typename... Ts>
struct is_non_primitive_tuple_element;
template <typename... Ts>
struct is_non_primitive_tuple_element<0, std::tuple<Ts...>> {
    static constexpr bool value = false;
};
template <size_t Index, typename... Ts>
struct is_non_primitive_tuple_element<Index, std::tuple<Ts...>> {
...
template <typename T>
struct is_non_primitive_tuple {
    static constexpr bool value = false;
};
template <typename... Ts>
struct is_non_primitive_tuple<std::tuple<Ts...>> {
    static constexpr bool value = is_non_primitive_tuple_element<sizeof...(Ts), std::tuple<Ts...>>::value;
};

template <typename T>
struct is_tuple_pair {
    static constexpr bool value = false;
};
template <typename T1, typename T2>
struct is_tuple_pair<std::tuple<T1, T2>> {
    static constexpr bool value = true;
};
...
template <typename Object, typename Value, size_t FieldIndex = NoFieldIndex, typename OpAnnotations = NoAnnotation, typename Field = NoField, Statics statics = Statics::Excluded,
...
template <typename Value, typename OpAnnotations = NoAnnotation, typename Field = NoField, Statics statics = Statics::Excluded, bool PrettyPrint = false, size_t IndentLevel = 0,
          const char* indent = twoSpaces>
...
template <typename Object, typename Value, size_t FieldIndex = NoFieldIndex, typename OpAnnotations = NoAnnotation, typename Field = NoField, Statics statics = Statics::Excluded,
          bool PrettyPrint = false, size_t IndentLevel = 0, const char* indent = twoSpaces>
static constexpr bool HaveSpecialization = is_specialized<Customize<Object, Value, FieldIndex, OpAnnotations, Field, statics, PrettyPrint, IndentLevel, indent>>::value ||  // Fully specialized
                                           ...
                                           is_specialized<CustomizeType<Value, OpAnnotations, Field, statics, PrettyPrint, IndentLevel, indent>>::value ||  // Fully specialized
...
OutStreamType& operator<<(OutStreamType& os, const IndentType<PrettyPrint, IndentLevel, indent>&) {
    if constexpr (IndentLevel > 0 && PrettyPrint) {
        for (size_t i = 0; i < IndentLevel; i++) os << indent;
    }
...
template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, typename Value>
static constexpr inline bool Customization(OutStreamType& os, Context& context, const Object& obj, const Value& value) {
    if constexpr (is_specialized<Customize<Object, Value, Field::Index, Annotations, Field, statics, PrettyPrint, IndentLevel, indent>>::value) {
        return Customize<Object, Value, Field::Index, Annotations, Field, statics, PrettyPrint, IndentLevel, indent>::As(os, context, obj, value);  // Customize fully specialized
    ...
    else if constexpr (is_specialized<CustomizeType<Value, Annotations, Field, statics, PrettyPrint, IndentLevel, indent>>::value) {
        return CustomizeType<Value, Annotations, Field, statics, PrettyPrint, IndentLevel, indent>::As(os, context, value);  // CustomizeType fully specialized
...
template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, bool IsFirst, bool IsComplexTuple = false,
...
template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, bool IsFirst, typename Key, typename T>
static constexpr void Pair(OutStreamType& os, Context& context, const Object& obj, const std::pair<Key, T>& value);

template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, typename IterableValue = uint_least8_t>
        ...
        case Generic::Value::Type::FieldCluster: {
            ...
            for (const auto& field : fieldCluster) {
                ...
                if (field.second == nullptr)
                    ...
                    Put::GenericValue<Annotations, PrettyPrint, indent, false>(os, context, indentLevel, (Generic::Value&)*field.second);
                }
...
static void GenericIterable(OutStreamType& os, Context& context, size_t indentLevel, const Generic::Value& iterable) {
    ...
    bool containsPrimitives = iterable.type() == Generic::Value::Type::BoolArray || iterable.type() == Generic::Value::Type::NumberArray || iterable.type() == Generic::Value::Type::StringArray;
        ...
        case Generic::Value::Type::Object: {
            ...
            for (const auto& field : obj) {
                ...
                if (field.second == nullptr)
                    ...
                    Put::GenericValue<Annotations, PrettyPrint, indent, false>(os, context, indentLevel + 1, (Generic::Value&)*field.second);
                }
                isFirst = false;
            }
        } break;
            ...
            for (const std::map<std::string, std::shared_ptr<Generic::Value>>& obj : array) {
                ...
                for (const auto& field : obj) {
                    ...
                    if (field.second == nullptr)
                        ...
                        Put::GenericValue<Annotations, PrettyPrint, indent, false>(os, context, indentLevel + 2, (Generic::Value&)*field.second);
                    }
                    isFirst = false;
                }
...
template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, bool IsFirst, typename T>
static constexpr void Value(OutStreamType& os, Context& context, const Object& obj, const T& value) {
    if constexpr (Customizers::HaveSpecialization<Object, T, Field::Index, Annotations, Field, statics, PrettyPrint, IndentLevel, indent>) {
        if (Put::Customization<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, T>(os, context, obj, value)) {
            return;
        }
    }
    ...
    if constexpr (ObjectMapper::HasDefaultMapping<T, typename Field::Annotations, Annotations>) {
        ...
        if (value == nullptr)
            ...
            Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, IsFirst>(os, context, obj, *value);
        }
        ...
        if constexpr (std::tuple_size<T>::value == 0)
            ...
            Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, IsFirst>(os, context, obj, std::get<0>(value));
        } else if constexpr (std::tuple_size<T>::value >= 2) {
            Put::Tuple<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, IsFirst>(os, context, obj, value);
        }
...
template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, bool IsFirst, bool IsComplexTuple, size_t TupleIndex,
...
static constexpr void Tuple(OutStreamType& os, Context& context, const Object& obj, const std::tuple<T1, T2, Ts...>& value) {
    ...
    if constexpr (TupleIndex == 0) Put::ArrayPrefix<PrettyPrint, !isComplexTuple, indent>(os, IndentLevel);
    if constexpr (TupleIndex < tupleSize) {
        Put::Separator<PrettyPrint, false, isComplexTuple, IndentLevel + 1, indent>(os, TupleIndex == 0);
        Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, IsFirst>(os, context, obj, std::get<TupleIndex>(value));
        Put::Tuple<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, IsFirst, isComplexTuple, TupleIndex + 1>(os, context, obj, value);
...
static constexpr void Pair(OutStreamType& os, Context& context, const Object& obj, const std::pair<Key, T>& value) {
    ...
    Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, IsFirst>(os, context, obj, value.first);
    Put::Separator<PrettyPrint, false, isComplexPair, IndentLevel + 1, indent>(os, false);
    Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, IsFirst>(os, context, obj, value.second);
...
static constexpr void KeyValueObject(OutStreamType& os, Context& context, const Object& obj, const std::pair<Key, T>& pair) {
    ...
    Put::String(os, "key");
    os << FieldNameValueSeparator<PrettyPrint>;
    Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, true>(os, context, obj, pair.first);
    os << StaticAffix::FieldPrefix<false, PrettyPrint, IndentLevel + 1, indent>;
    Put::String(os, "value");
    os << FieldNameValueSeparator<PrettyPrint>;
    Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, pair.second);
    os << StaticAffix::ObjectSuffix<PrettyPrint, IndentLevel, indent, statics>;
}

template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, bool IsFirst, typename T, typename Key>
static constexpr void FieldPair(OutStreamType& os, Context& context, const Object& obj, const std::pair<Key, T>& pair) {
    ...
    os << FieldNameValueSeparator<PrettyPrint>;
    Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel, indent, Object, IsFirst>(os, context, obj, pair.second);
}

template <typename Annotations, typename Field, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, typename IterableValue>
static constexpr void Iterable(OutStreamType& os, Context& context, const Object& obj, const IterableValue& iterable) {
    ...
    if constexpr (is_stl_iterable<IterableValue>::value) {
        for (auto& element : iterable) {
            ...
            if constexpr (!IsMap) {
                Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, element);
            } else if constexpr (HasComplexKey) {
                Put::KeyValueObject<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, element);
            } else {
                Put::FieldPair<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, element);
            }
        }
        ...
        for (auto it = sequenceContainer.begin(); it != sequenceContainer.end(); ++it) {
            Put::Separator<PrettyPrint, !IsArray, !ContainsPrimitives, IndentLevel + 1, indent>(os, 0 == i++);
            Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, *it);
        }
        ...
        for (; i < std::extent<typename Field::Type>::value; i++) {
            Put::Separator<PrettyPrint, !IsArray, !ContainsPrimitives, IndentLevel + 1, indent>(os, 0 == i);
            Put::Value<Annotations, Field, statics, PrettyPrint, IndentLevel + 1, indent, Object, false>(os, context, obj, iterable[i]);
        }
    }
    Put::NestedSuffix<PrettyPrint, IsArray, ContainsPrimitives, IndentLevel, indent>(os, IsEmpty(iterable));
}

template <typename Annotations, typename FieldClass, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, typename FieldName>
static constexpr void Field(OutStreamType& os, Context& context, const Object& obj, FieldName fieldName, const typename FieldClass::Type& value) {
    if constexpr (matches_statics<FieldClass::IsStatic, statics>::value) {
        if constexpr (std::is_base_of<Generic::FieldCluster, typename remove_pointer<typename FieldClass::Type>::type>::value) {
            if constexpr (FieldClass::Index == FirstIndex<statics, Object>())
                ...
                if (value != nullptr) Put::Value<Annotations, FieldClass, statics, PrettyPrint, IndentLevel, indent, Object, false>(os, context, obj, *value);
            } else
            ...
            os << FieldNameValueSeparator<PrettyPrint>;
            Put::Value<Annotations, FieldClass, statics, PrettyPrint, IndentLevel, indent, Object, FieldClass::Index == FirstIndex<statics, Object>()>(os, context, obj, value);
        }
    }
}
...
template <typename Annotations, size_t SuperIndex, typename T, Statics statics, bool PrettyPrint, size_t IndentLevel, const char* indent, typename Object, typename FieldName>
...
static constexpr void Supers(OutStreamType& os, Context& context, const Object& obj) {
    supers_t<Object>::ForEach(obj, [&](auto superInfo, auto& superObj) {
        ...
        if constexpr (SuperInfo::template HasAnnotation<json::Name>) {
            ...
            Put::Super<Annotations, decltype(superInfo)::Index, Super, statics, PrettyPrint, IndentLevel, indent, Object>(os, context, obj, superName);
        } else {
            Put::Super<Annotations, decltype(superInfo)::Index, Super, statics, PrettyPrint, IndentLevel, indent, Object>(os, context, obj, superTypeToJsonFieldName<Super>());
        }
    });
}
...
template <typename Annotations = NoAnnotation, Statics statics = Statics::Excluded, bool PrettyPrint = false, size_t IndentLevel = 0, const char* indent = twoSpaces, typename Object = uint_least8_t>
...
public:
    ...
    constexpr OutStreamType& put(OutStreamType& os) {
        if (context == nullptr) context = std::make_shared<Context>();

        Put::Value<Annotations, Fields::Field<Object, void, std::nullptr_t, 0, NoAnnotation>, statics, PrettyPrint, IndentLevel, indent, Object, true, Object>(os, *context, obj, obj);
...
#ifdef USE_BUFFERED_STREAMS
template <Statics statics = Statics::Excluded, typename Annotations = NoAnnotation, bool PrettyPrint = false, size_t IndentLevel = 0, const char* indent = twoSpaces, typename T = uint_least8_t>
...
template <Statics statics = Statics::Excluded, typename Annotations = NoAnnotation, size_t IndentLevel = 0, const char* indent = twoSpaces, typename T = uint_least8_t>
...
template <typename Object, typename Value, size_t FieldIndex = NoFieldIndex, typename OpAnnotations = NoAnnotation, typename Field = NoField>
static constexpr bool HaveSpecialization = is_specialized<Customize<Object, Value, FieldIndex, OpAnnotations, Field>>::value ||    // Fully specialized
                                           is_specialized<Customize<Object, Value, FieldIndex, OpAnnotations>>::value ||           // Customize<4args> specialized
                                           is_specialized<Customize<Object, Value, FieldIndex>>::value ||                          // Customize<3args> specialized
                                           is_specialized<Customize<Object, Value>>::value ||                                      // Customize<2args> specialized
                                           is_specialized<Customize<Object, Value, FieldIndex, NoAnnotation, Field>>::value ||     // Customize<5args>, OpAnnotations defaulted
...
public:
    InvalidNumericCharacter(char invalidCharacter, const char* expected) : Exception((std::string("Invalid numeric character: \"") + invalidCharacter + "\" expected: " + expected).c_str()) {}
};

class InvalidSecondDecimal : public Exception {
public:
    InvalidSecondDecimal() : Exception(std::string("Invalid second decimal, expected: [0-9], \",\", or \"}\"").c_str()) {}
};

class InvalidEscapeSequence : public Exception {
public:
    InvalidEscapeSequence(const char* escapeSequence, const char* expected) : Exception((std::string("Invalid escape sequence: \"") + escapeSequence + "\", expected: " + expected).c_str()) {}
};
...
public:
    FieldNameUnexpectedLineEnding(const UnexpectedLineEnding& e) : UnexpectedLineEnding((std::string("Expected field name close quote, found line ending (\"") + e.what() + "\")").c_str()) {}
};
...
static std::multimap<size_t, JsonField>& getClassFieldCache(const T& t) {
    ...
    if (found == classToNameHashToJsonField.end()) {
        auto inserted = classToNameHashToJsonField.insert(std::pair<std::type_index, std::multimap<size_t, JsonField>>(std::type_index(typeid(T)), std::multimap<size_t, JsonField>()));

        if (!inserted.second) throw Exception("Failed to create cache for class!");
            ...
            for (size_t fieldIndex = 0; fieldIndex < Class::TotalFields; fieldIndex++) {
                Class::FieldAt(fieldIndex, [&](auto& field) {
                    ...
                    if constexpr (std::is_base_of<Generic::FieldCluster, typename remove_pointer<typename Field::Type>::type>::value) {
                        ...
                        inserted.first->second.insert(std::pair<size_t, JsonField>(strHash(fieldName), JsonField(fieldIndex, JsonField::Type::FieldCluster, fieldName)));
                        ...
                        if constexpr (Field::template HasAnnotation<json::Name>) {
                            ...
                            inserted.first->second.insert(std::pair<size_t, JsonField>(strHash(fieldName.c_str()), JsonField(fieldIndex, JsonField::Type::Regular, fieldName.c_str())));
                        } else {
                            inserted.first->second.insert(
                                    std::pair<size_t, JsonField>(strHash(Class::Fields[fieldIndex].name), JsonField(fieldIndex, JsonField::Type::Regular, Class::Fields[fieldIndex].name)));
                        }
                    }
                });
            }
                ...
                Supers::At(t, superIndex, [&](auto superInfo, auto& superObj) {
                    ...
                    if constexpr (HasFields<Statics::Included, Super>()) {
                        if constexpr (SuperInfo::template HasAnnotation<json::Name>) {
                            ...
                            inserted.first->second.insert(std::pair<size_t, JsonField>(strHash(superName), JsonField(superIndex, JsonField::Type::SuperClass, superName)));
                        } else {
                            std::string superTypeFieldName = superTypeToJsonFieldName<Super>();
                            inserted.first->second.insert(std::pair<size_t, JsonField>(strHash(superTypeFieldName), JsonField(superIndex, JsonField::Type::SuperClass, superTypeFieldName)));
                        }
                    }
                });
            }
...
static JsonField* getJsonField(T& t, const std::string& fieldName) {
    ...
    for (auto it = fieldHashMatches.first; it != fieldHashMatches.second; ++it) {
        if (it->second.name.compare(fieldName) == 0) return &it->second;
    }
    return nullptr;
}
...
static void putClassFieldCache(std::ostream& os) {
    ...
    for (auto& pair : classToNameHashToJsonField) {
        ...
        for (auto& fieldNameToJsonField : pair.second) {
            if (hasPrevFieldNameToJsonField) os << "    }," << std::endl;
...
public:
    ...
    static constexpr inline bool tryGet(std::istream& is, int character, int secondaryCharacter, const char* expectedDescription, const char* secondaryDescription) {
        if (usePrimary)
    ...
    template <bool usePrimary>
    static constexpr inline bool getTrueFalse(std::istream& is, char trueChar, char falseChar, char secondaryFalseChar, const char* expectedDescription, const char* secondaryDescription) {
    ...
    static constexpr inline void get(std::istream& is, char& c, char expectation, char secondaryExpectation, const char* expectedDescription, const char* secondaryDescription) {
        ...
        if (!is.good()) {
            ...
            if (c != expectation) throw Exception((std::string("Expected: ") + expectedDescription).c_str());
        } else {
            if (c != secondaryExpectation) throw Exception((std::string("Expected: ") + secondaryDescription).c_str());
        }
    }

    static inline bool unget(std::istream& is, char ungetting) {
        is.unget();
        if (!is.good()) throw StreamUngetFail(ungetting);
...
static constexpr void Null(std::istream& is, char& c) {
    ...
    for (size_t i = 0; i < 4; i++) Checked::get<false>(is, c, expectation[i], "completion of field value");
...
static constexpr bool TryNull(std::istream& is, char& c) {
    ...
    if (c == 'n') {
        int expectation[] = {'n', 'u', 'l', 'l'};
        for (size_t i = 0; i < 4; i++) Checked::get<false>(is, c, expectation[i], "completion of \"null\"");
...
static constexpr void False(std::istream& is, char& c) {
    ...
    for (size_t i = 0; i < 5; i++) Checked::get<false>(is, c, expectation[i], "completion of field value");
...
static constexpr void Number(std::istream& is, char& c) {
    ...
    switch (c) {
        ...
        case '9':
            break;
        default:
            throw InvalidNumericCharacter(c, "\"-\" or [0-9]");
    }
    ...
    do {
        ...
        switch (c) {
            ...
            case ',':
                ...
                break;
            case terminator:
                Checked::unget(is, terminator);
                break;
            case ' ':
            case '\t':
            case '\n':
            case '\r':
                Checked::consumeWhitespace<InArray>(is, decimal ? "[0-9], \",\", or \"]\"" : "\".\", [0-9], \",\", or \"]\"", decimal ? "[0-9], \",\", or \"}\"" : "\".\", [0-9], \",\", or \"}\"");
                Checked::get<InArray>(is, c, decimal ? "[0-9], \",\", or \"]\"" : "\".\", [0-9], \",\", or \"]\"", decimal ? "[0-9], \",\", or \"}\"" : "\".\", [0-9], \",\", or \"}\"");
...
static constexpr void Value(std::istream& is, char& c) {
    ...
    switch (c) {
        ...
        case '9':
            ...
            break;  // Number or error
        case '{':
            Consume::Iterable<false>(is, c);
            break;  // JSON object or error
        case '[':
            Consume::Iterable<true>(is, c);
            break;  // JSON array or error
        case 't':
            Consume::True<InArray>(is, c);
            break;  // "true" or error
        case 'f':
            Consume::False<InArray>(is, c);
            break;  // "false" or error
        case 'n':
            Consume::Null<InArray>(is, c);
            break;  // "null" or error
        default:
...
static constexpr void Value(std::istream& is, char& c, std::stringstream& ss) {
    ...
    switch (c) {
        ...
        case '8':
        case '9':
            Consume::Number<InArray>(is, c, ss);
            break;  // Number or error
        case '{':
            Consume::Iterable<false>(is, c, ss);
            break;  // JSON object or error
        case '[':
            Consume::Iterable<true>(is, c, ss);
            break;  // JSON array or error
        case 't':
            Consume::True<InArray>(is, c, ss);
            break;  // "true" or error
        case 'f':
            Consume::False<InArray>(is, c, ss);
            break;  // "false" or error
        case 'n':
            Consume::Null<InArray>(is, c, ss);
            break;  // "null" or error
        default:
            throw InvalidUnknownFieldValue();
            break;
...
namespace Read {
inline namespace Affix {
inline void ObjectPrefix(std::istream& is, char& c) { Checked::get(is, c, '{', "object opening \"{\""); }

inline bool TryObjectSuffix(std::istream& is) { return Checked::tryGet(is, '}', "object closing \"}\" or field name opening \""); }

inline bool FieldSeparator(std::istream& is) { return Checked::getTrueFalse(is, ',', '}', "\",\" or object closing \"}\""); }

inline void FieldNameValueSeparator(std::istream& is, char& c) { Checked::get(is, c, ':', "field name-value separator \":\""); }

inline void ArrayPrefix(std::istream& is, char& c) { Checked::get(is, c, '[', "array opening \"[\""); }

inline bool TrySingularTupleArrayPrefix(std::istream& is, char& c) { return Checked::tryGet(is, '[', "array opening \"[\" or tuple value"); }

inline bool TryArraySuffix(std::istream& is) { return Checked::tryGet(is, ']', "array closing \"]\" or array element"); }
...
inline bool IterablePrefix(std::istream& is, char& c) {
    if (Checked::tryGet(is, '{', "object opening \"{\" or array opening \"[\"")) return true;
...
static constexpr void Bool(std::istream& is, char& c, Value& value) {
    ...
    if (c == 't') {
        Consume::True<InArray>(is, c);
        if constexpr (!std::is_const<Value>::value) value = true;
    } else if (c == 'f') {
        Consume::False<InArray>(is, c);
        if constexpr (!std::is_const<Value>::value) value = false;
    } else
...
static void String(std::istream& is, char& c, std::stringstream& ss) {
    if constexpr (ExpectQuotes) Checked::get(is, c, '\"', "string value open quote");
    do {
            ...
            case '\\':  // Escape sequence
                ...
                switch (c) {
                    ...
                    case 'u': {
                        ...
                        if (highCharacter > 0) ss.put(highCharacter);
...
static void String(std::istream& is, char& c, T& t) {
    std::stringstream ss;
    Read::String<ExpectQuotes>(is, c, ss);
    if constexpr (!std::is_const<T>::value) ss >> t;
}
...
static constexpr void EnumInt(std::istream& is, Value& value) {
    ...
    is >> temp;
    if constexpr (!std::is_const<EnumType>::value) value = (typename remove_pointer<Value>::type)temp;
}
...
static std::shared_ptr<Generic::Value::Assigner> GenericValue(std::istream& is, Context& context, char& c) {
    ...
    switch (c) {
        case '\"':
            return Generic::Value::Assigner::Make<Generic::String>(Read::String<>(is, c));  // String or error
        case '{':
            return Read::GenericObject(is, context, c);  // JSON object or error
        case '[':
            return Read::GenericArray<InArray>(is, context, c);  // JSON array or error
        case 't':
            return Generic::Value::Assigner::Make<Generic::Bool>(Read::True<InArray>(is, c));  // "true" or error
        case 'f':
            return Generic::Value::Assigner::Make<Generic::Bool>(Read::False<InArray>(is, c));  // "false" or error
        case '-':
        case '0':
        case '1':
        case '2':
...
static constexpr Generic::Value::Type ValueType(const char& c) {
    switch (c) {
        case '\"':
            return Generic::Value::Type::String;
        case '{':
            return Generic::Value::Type::Object;
        case '[':
            return Generic::Value::Type::Array;
        case 't':
        case 'f':
            return Generic::Value::Type::Boolean;
        case '-':
        case '0':
        case '1':
        case '2':
        ...
        case 'n':
            return Generic::Value::Type::Null;
        default:
            throw InvalidUnknownFieldValue();
    }
}
...
static std::shared_ptr<Generic::Value::Assigner> GenericArray(std::istream& is, Context& context, char& c) {
    ...
    if (Read::TryArraySuffix(is)) return Generic::Value::Assigner::Make<Generic::NullArray>();
    ...
    switch (arrayElementType) {
        case Generic::Value::Type::Null:
            result = Generic::Value::Assigner::Make<Generic::NullArray>();
            break;
        case Generic::Value::Type::Boolean:
            result = Generic::Value::Assigner::Make<Generic::BoolArray>();
            break;
        case Generic::Value::Type::Number:
            result = Generic::Value::Assigner::Make<Generic::NumberArray>();
            break;
        case Generic::Value::Type::String:
            result = Generic::Value::Assigner::Make<Generic::StringArray>();
            break;
        case Generic::Value::Type::Object:
            result = Generic::Value::Assigner::Make<Generic::ObjectArray>();
            break;
        case Generic::Value::Type::Array:
            result = Generic::Value::Assigner::Make<Generic::MixedArray>();
            break;
    }
    ...
    do {
        ...
        if (elementType != arrayElementType && arrayElementType != Generic::Value::Type::Array)  // Promote to mixed array
        {
            ...
            switch (arrayElementType) {
                case Generic::Value::Type::Null: {
                    for (size_t i = 0; i < result->get()->nullArray(); i++) mixedArray.push_back(nullptr);
                } break;
                case Generic::Value::Type::Boolean: {
                    const std::vector<bool>& boolArray = result->get()->boolArray();
                    for (size_t i = 0; i < boolArray.size(); i++) mixedArray.push_back(std::make_shared<Generic::Bool>(boolArray[i]));
                } break;
                case Generic::Value::Type::Number: {
                    const std::vector<std::string>& numberArray = result->get()->numberArray();
                    for (size_t i = 0; i < numberArray.size(); i++) mixedArray.push_back(std::make_shared<Generic::Number>(numberArray[i]));
                } break;
                case Generic::Value::Type::String: {
                    const std::vector<std::string>& stringArray = result->get()->stringArray();
                    for (size_t i = 0; i < stringArray.size(); i++) mixedArray.push_back(std::make_shared<Generic::String>(stringArray[i]));
                } break;
                case Generic::Value::Type::Object: {
                    const std::vector<std::map<std::string, std::shared_ptr<Generic::Value>>>& objectArray = result->get()->objectArray();
                    for (size_t i = 0; i < objectArray.size(); i++) mixedArray.push_back(std::make_shared<Generic::Object>(objectArray[i]));
                } break;
            }
        ...
        if (arrayElementType == Generic::Value::Type::Array) {
            switch (elementType) {
                case Generic::Value::Type::Null:
                    Consume::Null<true>(is, c);
                    result->get()->mixedArray().push_back(nullptr);
                    break;
                case Generic::Value::Type::Boolean:
                    result->get()->mixedArray().push_back(std::make_shared<Generic::Bool>(Read::Bool<true>(is, c)));
                    break;
                case Generic::Value::Type::Number:
                    result->get()->mixedArray().push_back(std::make_shared<Generic::Number>(Read::Number<true>(is, c)));
                    break;
                case Generic::Value::Type::String:
                    result->get()->mixedArray().push_back(std::make_shared<Generic::String>(Read::String<>(is, c)));
                    break;
                case Generic::Value::Type::Object:
                    result->get()->mixedArray().push_back(Read::GenericObject(is, context, c)->out());
                    break;
                case Generic::Value::Type::Array:
                    result->get()->mixedArray().push_back(Read::GenericArray<true>(is, context, c)->out());
                    break;
            }
        } else {
            switch (elementType) {
                case Generic::Value::Type::Null:
                    Consume::Null<true>(is, c);
                    result->get()->nullArray()++;
                    break;
                case Generic::Value::Type::Boolean:
                    result->get()->boolArray().push_back(Read::Bool<true>(is, c));
                    break;
                case Generic::Value::Type::Number:
                    result->get()->numberArray().push_back(Read::Number<true>(is, c));
                    break;
                case Generic::Value::Type::String:
                    result->get()->stringArray().push_back(Read::String<>(is, c));
                    break;
                case Generic::Value::Type::Object:
                    result->get()->objectArray().push_back(Read::GenericObject(is, context, c)->out()->object());
                    break;
                case Generic::Value::Type::Array:
                    result->get()->mixedArray().push_back(Read::GenericArray<true>(is, context, c)->out());
                    break;
    ...
    if constexpr (ObjectMapper::HasDefaultMapping<T, typename Field::Annotations, Annotations>) {
        ...
        if constexpr (std::is_base_of<Generic::Value, Dereferenced>::value) {
            if (Consume::TryNull<InArray>(is, c)) {
                if (!std::is_const<T>::value) value = nullptr;
        ...
        {
            if constexpr (!std::is_const<T>::value) value = nullptr;
        } else
            Read::Value<Annotations, InArray, Field>(is, context, c, object, *value);
    } else if constexpr (std::is_base_of<Generic::Value, T>::value) {
        ...
        if constexpr (std::tuple_size<T>::value == 0) {
            if (!Consume::TryNull<InArray>(is, c)) Consume::Iterable<true>(is, c);
        } else if constexpr (std::tuple_size<T>::value == 1) {
            if (Read::TrySingularTupleArrayPrefix(is, c)) {
                if (!Read::TryArraySuffix(is)) {
                    ...
                    while (Read::IterableElementSeparator<false>(is)) Consume::Value<true>(is, c);
                }
            } else
...
static constexpr void Tuple(std::istream& is, Context& context, char& c, Object& object, std::tuple<T1, T2, Ts...>& value) {
    constexpr size_t tupleSize = std::tuple_size<typename std::remove_reference_t<decltype(value)>>::value;
    if constexpr (TupleIndex == 0) Read::ArrayPrefix(is, c);

    if (!Read::TryArraySuffix(is)) {
        if constexpr (TupleIndex < tupleSize) {
            Read::Value<Annotations, true, Field>(is, context, c, object, std::get<TupleIndex>(value));
            if (Read::IterableElementSeparator<false>(is)) Read::Tuple<Annotations, Field, TupleIndex + 1, Object, T1, T2, Ts...>(is, context, c, object, value);
        } else {
            do {
