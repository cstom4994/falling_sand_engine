...
void MetaEngine::GameUI_Draw(Game *game) {
    ...
    InternalGUI::DebugDrawUI::Draw(game);
    InternalGUI::DebugCheatsUI::Draw(game);
    InternalGUI::MainMenuUI::Draw(game);
    InternalGUI::IngameUI::Draw(game);
}

namespace MetaEngine::InternalGUI {
