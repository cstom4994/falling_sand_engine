...
void nbt_tag_list_append(nbt_tag_t *list, nbt_tag_t *value) {
    list->tag_list.value = (nbt_tag_t **)gc_realloc(&gc, list->tag_list.value, (list->tag_list.size + 1) * sizeof(nbt_tag_t *));
...
void nbt_tag_compound_append(nbt_tag_t *compound, nbt_tag_t *value) {
    compound->tag_compound.value = (nbt_tag_t **)gc_realloc(&gc, compound->tag_compound.value, (compound->tag_compound.size + 1) * sizeof(nbt_tag_t *));
