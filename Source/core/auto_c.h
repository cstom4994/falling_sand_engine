...
#ifndef METADOT_DEBUG
#define METADOT_C_BOUND_CHECK 0
#define METADOT_C_MAGIC_CHECK 0
#define METADOT_C_ALLOC_CHECK 0
#define METADOT_C_NULL_CHECK 0
#define METADOT_C_METHOD_CHECK 0
#define METADOT_C_MEMORY_CHECK 0
#else
#define METADOT_C_BOUND_CHECK 1
#define METADOT_C_MAGIC_CHECK 1
#define METADOT_C_ALLOC_CHECK 1
#define METADOT_C_NULL_CHECK 1
#define METADOT_C_METHOD_CHECK 1
#define METADOT_C_MEMORY_CHECK 1
#endif

#if METADOT_C_ALLOC_CHECK == 1
#define METADOT_C_ALLOC_HEADER (var) AllocStatic,
#else
#define METADOT_C_ALLOC_HEADER
#endif
...
#define METADOT_C_CACHE_HEADER
#define METADOT_C_CACHE_NUM 0
#endif

#ifdef _WIN32
#define METADOT_C_WINDOWS
#endif

#ifdef __unix__
#define METADOT_C_UNIX
#define METADOT_C_LINUX
#endif

#ifdef __APPLE__
#define METADOT_C_UNIX
#define METADOT_C_MAC
#endif

#ifdef _MSC_VER
#define METADOT_C_MSC
#define popen _popen
...
#define slice_in(...) slice_stack($(Slice, NULL, $(Range, $I(0), 0, 0, 0)), tuple(__VA_ARGS__))
...
#define scan_from(input, pos, fmt, ...) scan_from_with(input, pos, fmt, tuple(__VA_ARGS__))
