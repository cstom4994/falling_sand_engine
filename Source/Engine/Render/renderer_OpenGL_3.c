#include "renderer_gpu_OpenGL_3.h"
...
#define SDL_METAENGINE_Render_SKIP_LINE_WIDTH
#define SDL_METAENGINE_Render_GLSL_VERSION 130
#define SDL_METAENGINE_Render_GLSL_VERSION_CORE 150
#define SDL_METAENGINE_Render_GL_MAJOR_VERSION 3
#define SDL_METAENGINE_Render_ENABLE_CORE_SHADERS
