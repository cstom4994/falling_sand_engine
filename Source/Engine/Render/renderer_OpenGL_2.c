#include "renderer_gpu_OpenGL_2.h"
#include "renderer_gpu_RendererImpl.h"


#if defined(SDL_METAENGINE_Render_DISABLE_OPENGL) || defined(SDL_METAENGINE_Render_DISABLE_OPENGL_2)

// Dummy implementations
METAENGINE_Render_Renderer* METAENGINE_Render_CreateRenderer_OpenGL_2(METAENGINE_Render_RendererID request) {return NULL;}
...
#define SDL_METAENGINE_Render_GLSL_VERSION 120
#define SDL_METAENGINE_Render_GL_MAJOR_VERSION 2
...
METAENGINE_Render_Renderer* METAENGINE_Render_CreateRenderer_OpenGL_2(METAENGINE_Render_RendererID request)
{
    ...
    renderer->id = request;
    renderer->id.renderer = METAENGINE_Render_RENDERER_OPENGL_2;
