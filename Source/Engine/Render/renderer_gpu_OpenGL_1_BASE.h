#ifndef _SDL_METAENGINE_Render_OPENGL_1_BASE_H__
#define _SDL_METAENGINE_Render_OPENGL_1_BASE_H__

#include "renderer_gpu.h"

#if !defined(SDL_METAENGINE_Render_DISABLE_OPENGL) && !defined(SDL_METAENGINE_Render_DISABLE_OPENGL_1_BASE)
