...
local pe = require('uidslexpr')

local helpstr = [[

usage:
  lua uidslparser.lua [-H path] [-I path] [-C] [-N name] [uidsl]
...
uidsl           : the uidsl input file, reads from stdin if missing
...
if ps then
    ...
    header:write('//Generated by MetaDot.UIDSLParser\n#pragma once\n')
    ...
    impl:write('//Generated by MetaDot.UIDSLParser\n')
    if outputcpp then
