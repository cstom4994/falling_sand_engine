#include "renderer_gpu_OpenGL_4.h"
...
#define RENDERER_RHI_ASSUME_CORE_FBO
#define RENDERER_RHI_ASSUME_SHADERS
#define RENDERER_RHI_SKIP_ENABLE_TEXTURE_2D
#define RENDERER_RHI_SKIP_LINE_WIDTH
#define RENDERER_RHI_GLSL_VERSION 150
#define RENDERER_RHI_GL_MAJOR_VERSION 4
...
#ifndef RENDERER_RHI_SKIP_LINE_WIDTH
...
METAENGINE_Render_Renderer* METAENGINE_Render_CreateRenderer_OpenGL_4(METAENGINE_Render_RendererID request)
{
    ...
    renderer->max_shader_version = RENDERER_RHI_GLSL_VERSION;
...
void METAENGINE_Render_FreeRenderer_OpenGL_4(METAENGINE_Render_Renderer* renderer)
{
    ...
    METAENGINE_FREE(renderer->impl);
    METAENGINE_FREE(renderer);
}
