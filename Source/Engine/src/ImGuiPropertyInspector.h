...
template <>
void draw<int, style::scroll_bar>(property::editor::undo::cmd<int> &Cmd, const int &Value, const property::editor::style_info<int> &I, property::flags::type Flags) noexcept;
template <>
void draw<int, style::drag>(property::editor::undo::cmd<int> &Cmd, const int &Value, const property::editor::style_info<int> &I, property::flags::type Flags) noexcept;
template <>
void draw<float, style::scroll_bar>(property::editor::undo::cmd<float> &Cmd, const float &Value, const property::editor::style_info<float> &I, property::flags::type Flags) noexcept;
template <>
void draw<float, style::drag>(property::editor::undo::cmd<float> &Cmd, const float &Value, const property::editor::style_info<float> &I, property::flags::type Flags) noexcept;
template <>
void draw<string_t, style::defaulted>(property::editor::undo::cmd<string_t> &Cmd, const string_t &Value, const property::editor::style_info<string_t> &I, property::flags::type Flags) noexcept;
template <>
void draw<string_t, style::enumeration>(property::editor::undo::cmd<string_t> &Cmd, const string_t &Value, const property::editor::style_info<string_t> &I, property::flags::type Flags) noexcept;
template <>
void draw<string_t, style::button>(property::editor::undo::cmd<string_t> &Cmd, const string_t &Value, const property::editor::style_info<string_t> &I, property::flags::type Flags) noexcept;

template <typename T>
inline void onRender(property::editor::undo::cmd<T> &Cmd, const T &Value, const property::table_entry &Entry, property::flags::type Flags) noexcept {
...
constexpr editor::style_info<int> edstyle<int>::ScrollBar(int Min, int Max, const char *pFormat) noexcept {
	return editor::style_info<int>{ editor::details::draw<int, editor::details::style::scroll_bar>, Min, Max, pFormat, 1 };
}

constexpr editor::style_info<int> edstyle<int>::Drag(float Speed, int Min, int Max, const char *pFormat) noexcept {
	return editor::style_info<int>{ editor::details::draw<int, editor::details::style::drag>, Min, Max, pFormat, Speed };
}

constexpr editor::style_info<float> edstyle<float>::ScrollBar(float Min, float Max, const char *pFormat, float Power) noexcept {
	return editor::style_info<float>{ editor::details::draw<float, editor::details::style::scroll_bar>, Min, Max, pFormat, 1.0f, Power };
}

constexpr editor::style_info<float> edstyle<float>::Drag(float Speed, float Min, float Max, const char *pFormat, float Power) noexcept {
	return editor::style_info<float>{ editor::details::draw<float, editor::details::style::drag>, Min, Max, pFormat, Speed, Power };
}

template <std::size_t N>
constexpr editor::style_info<string_t> edstyle<string_t>::Enumeration(const std::array<std::pair<const char *, int>, N> &Array) noexcept {
	return editor::style_info<string_t>{ editor::details::draw<string_t, editor::details::style::enumeration>, Array.data(), Array.size() };
}

constexpr editor::style_info<string_t> edstyle<string_t>::Button(void) noexcept {
	return editor::style_info<string_t>{ editor::details::draw<string_t, editor::details::style::button>, nullptr, 0 };
}

constexpr editor::style_info<string_t> edstyle<string_t>::Default(void) noexcept {
...
public:
	...
	inline inspector(const char *pName, bool isOpen = true) noexcept :
			m_pName{ pName }, m_bWindowOpen{ isOpen } {}
	...
	inline void setupWindowSize(int Width, int Height) noexcept {
		m_Width = Width;
		m_Height = Height;
	}
