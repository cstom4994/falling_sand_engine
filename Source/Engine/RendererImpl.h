...
typedef struct METAENGINE_Render_RendererImpl
{
    ...
    METAENGINE_Render_bool (*SaveImage)(METAENGINE_Render_Renderer *renderer,
    ...
    SDL_Surface *(*CopySurfaceFromTarget)(METAENGINE_Render_Renderer *renderer,
                                          METAENGINE_Render_Target *target);

    /*! \see METAENGINE_Render_CopySurfaceFromImage() */
    SDL_Surface *(*CopySurfaceFromImage)(METAENGINE_Render_Renderer *renderer,
                                         METAENGINE_Render_Image *image);
    ...
    SDL_Color (*GetPixel)(METAENGINE_Render_Renderer *renderer, METAENGINE_Render_Target *target,
                          Sint16 x, Sint16 y);
    ...
    Uint32 (*CompileShader_RW)(METAENGINE_Render_Renderer *renderer,
