...
STBTTF_Font *Drawing::LoadFont(const char *path, UInt16 ss) {
    ...
    /* prepare font */
    stbtt_fontinfo info;
    if (!stbtt_InitFont(&info, fontBuffer, 0)) { std::cout << "failed to init font" << std::endl; }
...
void Drawing::drawText(METAENGINE_Render_Target *target, const char *string, STBTTF_Font *font,
...
void Drawing::drawTextBG(METAENGINE_Render_Target *target, const char *string, STBTTF_Font *font,
                         int x, int y, uint8_t fR, uint8_t fG, uint8_t fB, SDL_Color bgCol,
                         int align) {
...
DrawTextParams_t Drawing::drawTextParams(METAENGINE_Render_Target *renderer, const char *string,
    ...
    DrawTextParams_t dtp{.string = string,
                         .font = font,
                         .x = x,
                         .y = y,
                         .fR = fR,
...
void Drawing::drawText(METAENGINE_Render_Target *target, DrawTextParams_t pm, int x, int y,
                       int align) {
