...
static const UInt32 R_NONE = 0x0;
 ...
 */
typedef UInt32 R_PrimitiveEnum;
 ...
 * \see R_PrimitiveBatchV()
 */
typedef UInt32 R_BatchFlagEnum;
...
void R_SetInitWindow(UInt32 windowID);

/*! Returns the window ID that has been set via R_SetInitWindow(). */
UInt32 R_GetInitWindow(void);
...
#define R_GLT_NULL 0
#define R_GLT_NULL_HANDLE 0

#define R_GLT_LEFT 0
#define R_GLT_TOP 0

#define R_GLT_CENTER 1

#define R_GLT_RIGHT 2
#define R_GLT_BOTTOM 2

static GLboolean R_GLT_Initialized = GL_FALSE;

typedef struct R_GLTtext R_GLTtext;
...
#define R_GLT_DestroyText R_GLT_DeleteText
...
typedef struct R_RendererImpl
{
    ...
    int (*GetAttributeLocation)(R_Renderer *renderer, UInt32 program_object,
                                const char *attrib_name);

    /*! \see R_GetUniformLocation() */
    int (*GetUniformLocation)(R_Renderer *renderer, UInt32 program_object,
