...
#define METAENGINE_Render_GL_VERSION_MAJOR 3
#define METAENGINE_Render_GL_VERSION_MINOR 2
...
typedef struct METAENGINE_Render_RendererImpl
{
    ...
    bool (*SetFullscreen)(METAENGINE_Render_Renderer *renderer, bool enable_fullscreen,
    ...
    bool (*ReplaceImage)(METAENGINE_Render_Renderer *renderer, METAENGINE_Render_Image *image,
...
#define METAENGINE_Render_INTROSPECTION_GENERATE_VARIABLE_RENDER(cputype, count, gltype, glread,   \
                                                                 glwrite, imguifunc)               \
    {                                                                                              \
...
#define METAENGINE_Render_INTROSPECTION_GENERATE_MATRIX_RENDER(cputype, rows, columns, gltype,     \
