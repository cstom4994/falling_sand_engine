...
void CAudioEngine::LoadSound(const std::string &strSoundName, bool b3d, bool bLooping,
                             bool bStream) {}

void CAudioEngine::UnLoadSound(const std::string &strSoundName) {}

int CAudioEngine::PlaySounds(const std::string &strSoundName, const Vector3 &vPosition,
                             float fVolumedB) {
    return 1;
}
...
bool CAudioEngine::IsEventPlaying(const std::string &strEventName) const { return false; }

void CAudioEngine::GetEventParameter(const std::string &strEventName,
                                     const std::string &strParameterName, float *parameter) {}

void CAudioEngine::SetEventParameter(const std::string &strEventName,
