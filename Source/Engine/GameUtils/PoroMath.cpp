...
namespace BaseEngine {
    namespace math {
        ...
        namespace {
            ...
            inline TType isLeft(const CVector2<TType> &p0, const CVector2<TType> &p1,
                                const CVector2<TType> &p2) {
 ...
 */
		 ...
		 */
			 ...
			 */
                        if ((vtx1.x - (vtx1.y - ty) * (vtx0.x - vtx1.x) / (vtx0.y - vtx1.y)) >=
                            tx) {
            ...
            /*
	{
		...
		if( dis > boxWidth.Length()  )
            ...
            return (-boxWidth.x <= point_pos.x && boxWidth.x > point_pos.x &&
                    -boxWidth.y <= point_pos.y && boxWidth.y > point_pos.y);
        }
        ...
        bool TestLineAABB(const CVector2<PointType> &p0, const CVector2<PointType> &p1,
                          const CVector2<PointType> &rect_min,
                          const CVector2<PointType> &rect_max) {
            ...
            if (abs(line_midpoint.x * line_halfwidth.y - line_midpoint.y * line_halfwidth.x) >
                rect_extents.x * ady + rect_extents.y * adx)
                return false;
