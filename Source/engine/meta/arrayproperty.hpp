...
protected:
     ...
     * \param value New value to assign to the element
     */
    virtual void setElement(const UserObject& object, size_t index, const Value& value) const = 0;
     ...
     * \param value Value of the element to insert
     */
    virtual void insertElement(const UserObject& object, size_t before, const Value& value) const = 0;
