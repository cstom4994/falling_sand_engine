...
I32 test() {
    ...
    meta_registry_register_class(
            &meta, thing_t,
            (&(meta_class_decl_t){.properties = (meta_property_t[]){meta_property(thing_t, u_val, META_PROPERTY_TYPE_INFO_U32), meta_property(thing_t, f_val, META_PROPERTY_TYPE_INFO_F32),
    ...
    meta_registry_register_class(&meta, other_thing_t,
                                 (&(meta_class_decl_t){.properties = (meta_property_t[]){meta_property(other_thing_t, s_val, META_PROPERTY_TYPE_INFO_S32)}, .size = 1 * sizeof(meta_property_t)}));
