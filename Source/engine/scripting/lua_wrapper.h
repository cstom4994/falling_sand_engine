...
int luacs_declare_field(lua_State *, enum luacstruct_type, const char *, const char *, size_t, int,
                        int, unsigned);
...
int luacs_newarraytype(lua_State *, const char *, enum luacstruct_type, const char *, size_t, int,
                       unsigned);
__END_DECLS
...
#define luacs_int_field(_L, _type, _field, _flags)                                                 \
    do {                                                                                           \
        static_assert(validintwidth(sizeof((struct _type *) 0)->_field),                           \
        ...
        luacs_declare_field((_L), _itype, NULL, #_field, sizeof(((struct _type *) 0)->_field),     \
...
#define luacs_enum_field(_L, _type, _etype, _field, _flags)                                        \
    do {                                                                                           \
        static_assert(validintwidth(sizeof((struct _type *) 0)->_field),                           \
                      "`" #_field "' is an unsupported int type");                                 \
        luacs_declare_field((_L), LUACS_TENUM, #_etype, #_field,                                   \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_bool_field(_L, _type, _field, _flags)                                                \
    do {                                                                                           \
        static_assert(sizeof(bool) == sizeof(((struct _type *) 0)->_field),                        \
                      "`" #_field "' is not a bool value");                                        \
        luacs_declare_field((_L), LUACS_TBOOL, NULL, #_field,                                      \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_bytearray_field(_L, _type, _field, _flags)                                           \
    do {                                                                                           \
        luacs_declare_field((_L), LUACS_TBYTEARRAY, NULL, #_field,                                 \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_string_field(_L, _type, _field, _flags)                                              \
    do {                                                                                           \
        luacs_declare_field((_L), LUACS_TSTRING, NULL, #_field,                                    \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_strptr_field(_L, _type, _field, _flags)                                              \
    do {                                                                                           \
        static_assert(sizeof(char *) == sizeof(((struct _type *) 0)->_field),                      \
                      "`" #_field "' is not a pointer value");                                     \
        luacs_declare_field((_L), LUACS_TSTRPTR, NULL, #_field,                                    \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_objref_field(_L, _type, _tname, _field, _flags)                                      \
    do {                                                                                           \
        static_assert(sizeof(void *) == sizeof(((struct _type *) 0)->_field),                      \
                      "`" #_field "' is not a pointer value");                                     \
        luacs_declare_field((_L), LUACS_TOBJREF, #_tname, #_field,                                 \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_nested_field(_L, _type, _tname, _field, _flags)                                      \
    do {                                                                                           \
        luacs_declare_field((_L), LUACS_TOBJENT, #_tname, #_field,                                 \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
#define luacs_extref_field(_L, _type, _field, _flags)                                              \
    do {                                                                                           \
        luacs_declare_field((_L), LUACS_TEXTREF, NULL, #_field,                                    \
                            sizeof(((struct _type *) 0)->_field), offsetof(struct _type, _field),  \
                            0, _flags);                                                            \
    } while (0 /*CONSTCOND*/)
...
#define luacs_int_array_field(_L, _type, _field, _flags)                                           \
    do {                                                                                           \
        static_assert(validintwidth(sizeof((struct _type *) 0)->_field[0]),                        \
                      "`" #_field "' is an unsupported int type");                                 \
        enum luacstruct_type _itype;                                                               \
        ...
        luacs_declare_field((_L), _itype, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),  \
                            offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), \
                            _flags);                                                               \
    } while (0 /*CONSTCOND*/)
...
#define luacs_bool_array_field(_L, _type, _field, _flags)                                          \
    do {                                                                                           \
        static_assert(sizeof(bool) == sizeof(((struct _type *) 0)->_field[0]),                     \
                      "`" #_field "' is not a bool value");                                        \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TBOOL, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),         \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_bytearray_array_field(_L, _type, _field, _flags)                                     \
    do {                                                                                           \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TBYTEARRAY, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),    \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_string_array_field(_L, _type, _field, _flags)                                        \
    do {                                                                                           \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TSTRING, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),       \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_strptr_array_field(_L, _type, _field, _flags)                                        \
    do {                                                                                           \
        static_assert(sizeof(char *) == sizeof(((struct _type *) 0)->_field[0]),                   \
                      "`" #_field "' is not a pointer value");                                     \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TSTRPTR, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),       \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)

#define luacs_objref_array_field(_L, _type, _tname, _field, _flags)                                \
    do {                                                                                           \
        static_assert(sizeof(void *) == sizeof(((struct _type *) 0)->_field[0]),                   \
                      "`" #_field "' is not a pointer value");                                     \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TOBJREF, #_tname, #_field, sizeof(((struct _type *) 0)->_field[0]),    \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_nested_array_field(_L, _type, _tname, _field, _flags)                                \
    do {                                                                                           \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TOBJENT, #_tname, #_field, sizeof(((struct _type *) 0)->_field[0]),    \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_extref_array_field(_L, _type, _field, _flags)                                        \
    do {                                                                                           \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TEXTREF, NULL, #_field, sizeof(((struct _type *) 0)->_field[0]),       \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
#define luacs_array_array_field(_L, _type, _tname, _field, _flags)                                 \
    do {                                                                                           \
        luacs_declare_field(                                                                       \
                (_L), LUACS_TARRAY, #_tname, #_field, sizeof(((struct _type *) 0)->_field[0]),     \
                offsetof(struct _type, _field), _nitems(((struct _type *) 0)->_field), _flags);    \
    } while (0 /*CONSTCOND*/)
