...
#define AST_END(type, name)                                                                        \
    ...
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<false, variable_pair_t, normal_pair_t, MacroName_t, macro_name_pair_t,
                 import_all_macro_t, Exp_t, meta_variable_pair_t, meta_normal_pair_t>
            items;
    ...
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<true, variable_pair_t, normal_pair_t, meta_variable_pair_t, meta_normal_pair_t>
            pairs;
    ...
    ast_sel<true, const_value_t, If_t, Switch_t, With_t, ClassDecl_t, ForEach_t, For_t, While_t,
            Do_t, Try_t, unary_value_t, TblComprehension_t, TableLit_t, Comprehension_t, FunLit_t,
            Num_t>
            value;
    ...
    AST_NODE(ChainValue)
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<true, Callable_t, Invoke_t, DotChainItem_t, ColonChainItem_t, Slice_t, Exp_t,
                 String_t, InvokeArgs_t, existential_op_t, table_appending_op_t>
            items;
    ...
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<true, Callable_t, Invoke_t, DotChainItem_t, ColonChainItem_t, Exp_t, String_t>
            items;
    ...
    AST_NODE(TableLit)
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<false, variable_pair_def_t, normal_pair_def_t, SpreadExp_t, normal_def_t,
                 meta_variable_pair_def_t, meta_normal_pair_def_t, variable_pair_t, normal_pair_t,
                 Exp_t, TableBlockIndent_t, meta_variable_pair_t, meta_normal_pair_t>
            values;
    ...
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<false, variable_pair_t, normal_pair_t, Exp_t, TableBlockIndent_t,
    ...
    AST_NODE(TableBlock)
    ast_ptr<true, Seperator_t> sep;
    ast_sel_list<false, variable_pair_t, normal_pair_t, TableBlockIndent_t, Exp_t, TableBlock_t,
                 SpreadExp_t, meta_variable_pair_t, meta_normal_pair_t>
            values;
    ...
    ast_sel<true, Import_t, While_t, Repeat_t, For_t, ForEach_t, Return_t, Local_t, Global_t,
            Export_t, Macro_t, MacroInPlace_t, BreakLoop_t, Label_t, Goto_t, ShortTabAppending_t,
