 ...
 *  This is equivalent to coloring with pure opaque white (255, 255, 255, 255). */
    ...
    void R_SetBlendFunction(R_Image *image, R_BlendFuncEnum source_color,
                            R_BlendFuncEnum dest_color, R_BlendFuncEnum source_alpha,
                            R_BlendFuncEnum dest_alpha);
 ...
 *  @{ */
    ...
    void R_MatrixFrustum(float *result, float left, float right, float bottom, float top,
                         float z_near, float z_far);
 ...
 *  @{ */
    ...
    * \param scaleY Vertical stretch factor */
    void R_BlitScale(R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y,
 ...
 */
    void R_TriangleBatch(R_Image *image, R_Target *target, unsigned short num_vertices,
                         float *values, unsigned int num_indices, unsigned short *indices,
 ...
 * \param flags Bit flags to control the interpretation of the 'values' array parameters.
 */
    void R_TriangleBatchX(R_Image *image, R_Target *target, unsigned short num_vertices,
 ...
 * \param color The color of the shape to render
 */
    void R_Rectangle(R_Target *target, float x1, float y1, float x2, float y2,
                     METAENGINE_Color color);
 ...
 * \param color The color of the shape to render
 */
    void R_RectangleRoundFilled(R_Target *target, float x1, float y1, float x2, float y2,
 ...
 * \param color The color of the shape to render
 */
    void R_RectangleRoundFilled2(R_Target *target, R_Rect rect, float radius,
                                 METAENGINE_Color color);
 ...
 */
    ...
    R_AttributeFormat R_MakeAttributeFormat(int num_elems_per_vertex, R_TypeEnum type,
                                            R_bool normalize, int stride_bytes, int offset_bytes);
...
#define R_Text_DestroyText R_Text_DeleteText
     ...
     * The extra parameter is used internally to reuse/reinit a target. */
        ...
        /*! \see R_Blit() */
        void (*Blit)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target,
                     float x, float y);
        ...
        /*! \see R_BlitTransform */
        void (*BlitTransform)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect,
                              R_Target *target, float x, float y, float degrees, float scaleX,
                              float scaleY);

        /*! \see R_BlitTransformX() */
        void (*BlitTransformX)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect,
                               R_Target *target, float x, float y, float pivot_x, float pivot_y,
                               float degrees, float scaleX, float scaleY);
        ...
        void (*SetUniformMatrixfv)(R_Renderer *renderer, int location, int num_matrices,
                                   int num_rows, int num_columns, R_bool transpose, float *values);
        ...
        /*! \see R_DrawPixel() */
        void (*DrawPixel)(R_Renderer *renderer, R_Target *target, float x, float y,
                          METAENGINE_Color color);
        ...
        /*! \see R_Ellipse() */
        void (*Ellipse)(R_Renderer *renderer, R_Target *target, float x, float y, float rx,
        ...
        void (*RectangleFilled)(R_Renderer *renderer, R_Target *target, float x1, float y1,
