...
typedef struct R_RendererImpl {
    ...
    /*! \see R_SetFullscreen() */
    R_bool (*SetFullscreen)(R_Renderer *renderer, R_bool enable_fullscreen, R_bool use_desktop_resolution);
    ...
    /*! \see R_CreateImageUsingTexture() */
    R_Image *(*CreateImageUsingTexture)(R_Renderer *renderer, R_TextureHandle handle, R_bool take_ownership);
    ...
    /*! \see R_UpdateImage */
    void (*UpdateImage)(R_Renderer *renderer, R_Image *image, const R_Rect *image_rect, void *surface, const R_Rect *surface_rect);

    /*! \see R_UpdateImageBytes */
    void (*UpdateImageBytes)(R_Renderer *renderer, R_Image *image, const R_Rect *image_rect, const unsigned char *bytes, int bytes_per_row);

    /*! \see R_ReplaceImage */
    R_bool (*ReplaceImage)(R_Renderer *renderer, R_Image *image, void *surface, const R_Rect *surface_rect);

    /*! \see R_CopyImageFromSurface() */
    R_Image *(*CopyImageFromSurface)(R_Renderer *renderer, void *surface, const R_Rect *surface_rect);
    ...
    /*! \see R_Blit() */
    void (*Blit)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y);

    /*! \see R_BlitRotate() */
    void (*BlitRotate)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y, float degrees);

    /*! \see R_BlitScale() */
    void (*BlitScale)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y, float scaleX, float scaleY);

    /*! \see R_BlitTransform */
    void (*BlitTransform)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y, float degrees, float scaleX, float scaleY);

    /*! \see R_BlitTransformX() */
    void (*BlitTransformX)(R_Renderer *renderer, R_Image *image, R_Rect *src_rect, R_Target *target, float x, float y, float pivot_x, float pivot_y, float degrees, float scaleX, float scaleY);
    ...
    void (*SetUniformMatrixfv)(R_Renderer *renderer, int location, int num_matrices, int num_rows, int num_columns, R_bool transpose, float *values);
    ...
    /*! \see R_Polyline() */
    void (*Polyline)(R_Renderer *renderer, R_Target *target, unsigned int num_vertices, float *vertices, METAENGINE_Color color, R_bool close_loop);
