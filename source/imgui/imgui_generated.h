// this file is automatically generated by ImGuiCSS tools
...
public:
    SliderAngle() : label(NULL), v_rad(NULL), v_degrees_min(-360.0f), v_degrees_max(+360.0f), format(ImStrdup("%.0f deg")) {}
    virtual ~SliderAngle() {
    ...
    void renderBody() { ImGui::SliderAngle(label, v_rad, v_degrees_min, v_degrees_max, format); }
    char* label;
    float* v_rad;
    float v_degrees_min;
    float v_degrees_max;
...
public:
    InputInt3() : label(NULL), v{0}, flags(0) {}
    virtual ~InputInt3() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::InputInt3(label, v, flags); }
    char* label;
    int v[3];
...
public:
    InputDouble() : label(NULL), v(NULL), step(0.0), step_fast(0.0), format(ImStrdup("%.6f")), flags(0) {}
    virtual ~InputDouble() {
        if (label != NULL) ImGui::MemFree(label);
    ...
    void renderBody() { ImGui::InputDouble(label, v, step, step_fast, format, flags); }
    char* label;
    double* v;
    double step;
    double step_fast;
...
public:
    DragInt3() : label(NULL), v{0}, v_speed(1.0f), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~DragInt3() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragInt3(label, v, v_speed, v_min, v_max, format); }
    char* label;
    int v[3];
    float v_speed;
    int v_min;
...
public:
    DragInt2() : label(NULL), v{0}, v_speed(1.0f), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~DragInt2() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragInt2(label, v, v_speed, v_min, v_max, format); }
    char* label;
    int v[2];
    float v_speed;
    int v_min;
...
public:
    Window() : name(NULL), p_open(true), flags(0) {}
    virtual ~Window() {
...
public:
    SliderInt() : label(NULL), v(0), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~SliderInt() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderInt(label, &v, v_min, v_max, format); }
    char* label;
    int v;
    int v_min;
    int v_max;
...
public:
    DragInt4() : label(NULL), v{0}, v_speed(1.0f), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~DragInt4() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragInt4(label, v, v_speed, v_min, v_max, format); }
    char* label;
    int v[4];
    float v_speed;
    int v_min;
...
public:
    InputFloat3() : label(NULL), v{0.0f}, format(ImStrdup("%.3f")), flags(0) {}
    virtual ~InputFloat3() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::InputFloat3(label, v, format, flags); }
    char* label;
    float v[3];
    char* format;
    ImGuiInputTextFlags flags;
...
public:
    InvisibleButton() : str_id(NULL) {}
    virtual ~InvisibleButton() {
        if (str_id != NULL) ImGui::MemFree(str_id);
    }

    void renderBody() { ImGui::InvisibleButton(str_id, size); }
    char* str_id;
};
...
public:
    Combo() : label(NULL), preview_value(NULL), flags(0) {}
    virtual ~Combo() {
        if (label != NULL) ImGui::MemFree(label);
...
public:
    MenuItem() : label(NULL), shortcut(NULL), selected(false), enabled(true) {}
    virtual ~MenuItem() {
        if (label != NULL) ImGui::MemFree(label);
        if (shortcut != NULL) ImGui::MemFree(shortcut);
    }

    void renderBody() { ImGui::MenuItem(label, shortcut, selected, enabled); }
    char* label;
    char* shortcut;
    bool selected;
    bool enabled;
...
public:
    SliderFloat3() : label(NULL), v{0.0f}, v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~SliderFloat3() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderFloat3(label, v, v_min, v_max, format, power); }
    char* label;
    float v[3];
    float v_min;
    float v_max;
...
public:
    SliderFloat2() : label(NULL), v{0.0f}, v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~SliderFloat2() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderFloat2(label, v, v_min, v_max, format, power); }
    char* label;
    float v[2];
    float v_min;
    float v_max;
...
public:
    SliderFloat4() : label(NULL), v{0.0f}, v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~SliderFloat4() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderFloat4(label, v, v_min, v_max, format, power); }
    char* label;
    float v[4];
    float v_min;
    float v_max;
...
public:
    ComboItem() : label(NULL), current_item(0), items(NULL), items_count(0), popup_max_height_in_items(-1) {}
    virtual ~ComboItem() {
        if (label != NULL) ImGui::MemFree(label);
        if (items != NULL) ImGui::MemFree(items);
    }

    void renderBody() { ImGui::Combo(label, &current_item, &items, items_count, popup_max_height_in_items); }
    char* label;
    int current_item;
    char* items;
    int items_count;
...
public:
    ...
    void renderBody() { ImGui::AlignTextToFramePadding(); }
};

class Popup : public ContainerElement {

public:
    Popup() : str_id(NULL), flags(0) {}
    virtual ~Popup() {
        if (str_id != NULL) ImGui::MemFree(str_id);
    }
...
public:
    PopupContextWindow() : str_id(NULL), mouse_button(1), also_over_items(true) {}
    virtual ~PopupContextWindow() {
        if (str_id != NULL) ImGui::MemFree(str_id);
    }

    void renderBody() {
        if (ImGui::BeginPopupContextWindow(str_id)) {
            ContainerElement::renderBody();
            ImGui::EndPopup();
        }
    }
...
public:
    DragFloatRange2() : label(NULL), v_current_min(NULL), v_current_max(NULL), v_speed(1.0f), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), format_max(NULL), power(1.0f) {}
    ...
    void renderBody() { ImGui::DragFloatRange2(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, power); }
    char* label;
    float* v_current_min;
    float* v_current_max;
    float v_speed;
...
public:
    PlotLines() : label(NULL), values(NULL), values_count(0), values_offset(0), overlay_text(NULL), scale_min(FLT_MAX), scale_max(FLT_MAX), graph_size(ImVec2(0, 0)), stride(sizeof(float)) {}
    virtual ~PlotLines() {
        if (label != NULL) ImGui::MemFree(label);
    ...
    void renderBody() { ImGui::PlotLines(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride); }
    char* label;
    float* values;
    int values_count;
    int values_offset;
...
public:
    ...
    void renderBody() { ImGui::Spacing(); }
};

class InputTextMultiline : public Element {

public:
    InputTextMultiline() : label(NULL), buf(NULL), buf_size(512), flags(0), callback(NULL), user_data(NULL) {
    ...
    void renderBody() { ImGui::InputTextMultiline(label, buf, buf_size, size, flags, callback, user_data); }
    char* label;
    char* buf;
    size_t buf_size;
    ImGuiInputTextFlags flags;
...
public:
    Selectable() : label(NULL), selected(false), flags(0) {}
    virtual ~Selectable() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::Selectable(label, selected, flags, size); }
    char* label;
    bool selected;
...
public:
    ColorEdit3() : label(NULL), col{0.0f}, flags(0) {}
    virtual ~ColorEdit3() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::ColorEdit3(label, col, flags); }
    char* label;
    float col[3];
...
public:
    ...
    void renderBody() { ImGui::NextColumn(); }
};

class ColorEdit4 : public Element {

public:
    ColorEdit4() : label(NULL), col{0.0f}, flags(0) {}
    virtual ~ColorEdit4() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::ColorEdit4(label, col, flags); }
    char* label;
    float col[4];
    ImGuiColorEditFlags flags;
};
...
public:
    SmallButton() : label(NULL) {}
    virtual ~SmallButton() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::SmallButton(label); }
    char* label;
};
...
public:
    Child() : str_id(NULL), border(false), flags(0) {}
    virtual ~Child() {
        if (str_id != NULL) ImGui::MemFree(str_id);
    }
...
public:
    PopupContextItem() : str_id(NULL), mouse_button(1) {}
...
public:
    InputInt() : label(NULL), v(0), step(1), step_fast(100), flags(0) {}
    virtual ~InputInt() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::InputInt(label, &v, step, step_fast, flags); }
    char* label;
    int v;
    int step;
    int step_fast;
...
public:
    TabItem() : label(NULL), p_open(true), flags(0) {}
    virtual ~TabItem() {
        if (label != NULL) ImGui::MemFree(label);
    }
...
public:
    ...
    void renderBody() { ImGui::Dummy(size); }
};

class Unindent : public Element {

public:
    Unindent() : indent_w(0.0f) {}

    void renderBody() { ImGui::Unindent(indent_w); }
    float indent_w;
};
...
public:
    Indent() : indent_w(0.0f) {}

    void renderBody() { ImGui::Indent(indent_w); }
    float indent_w;
};
...
public:
    ...
    void renderBody() { ImGui::Button(label, size); }
    char* label;
};
...
public:
    InputFloat2() : label(NULL), v{0.0f}, format(ImStrdup("%.3f")), flags(0) {}
    virtual ~InputFloat2() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::InputFloat2(label, v, format, flags); }
    char* label;
    float v[2];
    char* format;
    ImGuiInputTextFlags flags;
...
public:
    ColorPicker4() : label(NULL), col{0.0f}, flags(0), ref_col(NULL) {}
    virtual ~ColorPicker4() {
        if (label != NULL) ImGui::MemFree(label);
        if (ref_col != NULL) ImGui::MemFree(ref_col);
    }

    void renderBody() { ImGui::ColorPicker4(label, col, flags, ref_col); }
    char* label;
    float col[4];
    ImGuiColorEditFlags flags;
    float* ref_col;
...
public:
    InputFloat() : label(NULL), v(NULL), step(0.0f), step_fast(0.0f), format(ImStrdup("%.3f")), flags(0) {}
    virtual ~InputFloat() {
        if (label != NULL) ImGui::MemFree(label);
        if (v != NULL) ImGui::MemFree(v);
        if (format != NULL) ImGui::MemFree(format);
    ...
    void renderBody() { ImGui::InputFloat(label, v, step, step_fast, format, flags); }
    char* label;
    float* v;
    float step;
    float step_fast;
...
public:
    RadioButton() : label(NULL), active(true) {}
    virtual ~RadioButton() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::RadioButton(label, active); }
    char* label;
    bool active;
};
...
public:
    Checkbox() : label(NULL), v(true) {}
    virtual ~Checkbox() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::Checkbox(label, &v); }
    char* label;
    bool v;
};
...
public:
    ...
    void renderBody() { ImGui::Separator(); }
};

class VSliderFloat : public Element {

public:
    VSliderFloat() : label(NULL), v(NULL), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    ...
    void renderBody() { ImGui::VSliderFloat(label, size, v, v_min, v_max, format, power); }
    char* label;
    float* v;
    float v_min;
    float v_max;
...
public:
    PopupModal() : name(NULL), p_open(true), flags(0) {}
    virtual ~PopupModal() {
        if (name != NULL) ImGui::MemFree(name);
    }
...
public:
    DragFloat() : label(NULL), v(NULL), v_speed(1.0f), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~DragFloat() {
        if (label != NULL) ImGui::MemFree(label);
        if (v != NULL) ImGui::MemFree(v);
        if (format != NULL) ImGui::MemFree(format);
    ...
    void renderBody() { ImGui::DragFloat(label, v, v_speed, v_min, v_max, format, power); }
    char* label;
    float* v;
    float v_speed;
    float v_min;
...
public:
    PopupContextVoid() : str_id(NULL), mouse_button(1) {}
...
public:
    ...
    void renderBody() { ImGui::Columns(count, id, border); }
    int count;
    char* id;
    bool border;
};
...
public:
    ColorButton() : desc_id(NULL), flags(0) {}
    virtual ~ColorButton() {
        if (desc_id != NULL) ImGui::MemFree(desc_id);
    }

    void renderBody() { ImGui::ColorButton(desc_id, col, flags, size); }
    char* desc_id;
    ImVec4 col;
    ImGuiColorEditFlags flags;
};
...
public:
    SliderInt4() : label(NULL), v{0}, v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~SliderInt4() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderInt4(label, v, v_min, v_max, format); }
    char* label;
    int v[4];
    int v_min;
    int v_max;
...
public:
    PlotHistogram() : label(NULL), values(NULL), values_count(0), values_offset(0), overlay_text(NULL), scale_min(FLT_MAX), scale_max(FLT_MAX), graph_size(ImVec2(0, 0)), stride(sizeof(float)) {}
    ...
    void renderBody() { ImGui::PlotHistogram(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride); }
    char* label;
    float* values;
    int values_count;
    int values_offset;
...
public:
    InputInt2() : label(NULL), v{0}, flags(0) {}
    virtual ~InputInt2() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::InputInt2(label, v, flags); }
    char* label;
    int v[2];
    ImGuiInputTextFlags flags;
};
...
public:
    SliderInt2() : label(NULL), v{0}, v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~SliderInt2() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderInt2(label, v, v_min, v_max, format); }
    char* label;
    int v[2];
    int v_min;
    int v_max;
...
public:
    SliderInt3() : label(NULL), v{0}, v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~SliderInt3() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::SliderInt3(label, v, v_min, v_max, format); }
    char* label;
    int v[3];
    int v_min;
    int v_max;
...
public:
    ImageButton() : user_texture_id(NULL), uv0(ImVec2(0, 0)), uv1(ImVec2(1, 1)), frame_padding(-1), bg_col(ImVec4(0, 0, 0, 0)), tint_col(ImVec4(1, 1, 1, 1)) {}

    void renderBody() { ImGui::ImageButton(user_texture_id, size, uv0, uv1, frame_padding, bg_col, tint_col); }
...
public:
    DragFloat3() : label(NULL), v{0.0f}, v_speed(1.0f), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~DragFloat3() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragFloat3(label, v, v_speed, v_min, v_max, format, power); }
    char* label;
    float v[3];
    float v_speed;
    float v_min;
...
public:
    Image() : user_texture_id(NULL), uv0(ImVec2(0, 0)), uv1(ImVec2(1, 1)), tint_col(ImVec4(1, 1, 1, 1)), border_col(ImVec4(0, 0, 0, 0)) {}

    void renderBody() { ImGui::Image(user_texture_id, size, uv0, uv1, tint_col, border_col); }
    ImTextureID user_texture_id;
    ImVec2 uv0;
    ImVec2 uv1;
    ImVec4 tint_col;
...
public:
    InputTextWithHint() : label(NULL), hint(NULL), buf(NULL), buf_size(512), flags(0), callback(NULL), user_data(NULL) {
        buf = (char*)ImGui::MemAlloc(buf_size);
        buf[0] = '\0';
    }
    ...
    void renderBody() { ImGui::InputTextWithHint(label, hint, buf, buf_size, flags, callback, user_data); }
    char* label;
    char* hint;
    char* buf;
    size_t buf_size;
...
public:
    ColorPicker3() : label(NULL), col{0.0f}, flags(0) {}
    virtual ~ColorPicker3() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::ColorPicker3(label, col, flags); }
    char* label;
    float col[3];
    ImGuiColorEditFlags flags;
};
...
public:
    DragFloat4() : label(NULL), v{0.0f}, v_speed(1.0f), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~DragFloat4() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragFloat4(label, v, v_speed, v_min, v_max, format, power); }
    char* label;
    float v[4];
    float v_speed;
    float v_min;
...
public:
    ProgressBar() : fraction(0.0f), overlay(NULL) {}
    virtual ~ProgressBar() {
        if (overlay != NULL) ImGui::MemFree(overlay);
    }

    void renderBody() { ImGui::ProgressBar(fraction, size, overlay); }
    float fraction;
    char* overlay;
};
...
public:
    DragFloat2() : label(NULL), v{0.0f}, v_speed(1.0f), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~DragFloat2() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragFloat2(label, v, v_speed, v_min, v_max, format, power); }
    char* label;
    float v[2];
    float v_speed;
    float v_min;
...
public:
    VSliderInt() : label(NULL), v(0), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~VSliderInt() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::VSliderInt(label, size, &v, v_min, v_max, format); }
    char* label;
    int v;
    int v_min;
    int v_max;
...
public:
    SameLine() : offset_from_start_x(0.0f), spacing(-1.0f) {}

    void renderBody() { ImGui::SameLine(offset_from_start_x, spacing); }
...
public:
    InputFloat4() : label(NULL), v{0.0f}, format(ImStrdup("%.3f")), flags(0) {}
    virtual ~InputFloat4() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::InputFloat4(label, v, format, flags); }
    char* label;
    float v[4];
    char* format;
    ImGuiInputTextFlags flags;
...
public:
    InputText() : label(NULL), buf(NULL), buf_size(512), flags(0), callback(NULL), user_data(NULL) {
        buf = (char*)ImGui::MemAlloc(buf_size);
        buf[0] = '\0';
    }
    virtual ~InputText() {
    ...
    void renderBody() { ImGui::InputText(label, buf, buf_size, flags, callback, user_data); }
    char* label;
    char* buf;
    size_t buf_size;
    ImGuiInputTextFlags flags;
...
public:
    ArrowButton() : str_id(NULL) {}
    virtual ~ArrowButton() {
        if (str_id != NULL) ImGui::MemFree(str_id);
    }

    void renderBody() { ImGui::ArrowButton(str_id, dir); }
    char* str_id;
    ImGuiDir dir;
};
...
public:
    SliderFloat() : label(NULL), v(NULL), v_min(0.0f), v_max(0.0f), format(ImStrdup("%.3f")), power(1.0f) {}
    virtual ~SliderFloat() {
        if (label != NULL) ImGui::MemFree(label);
        if (v != NULL) ImGui::MemFree(v);
        if (format != NULL) ImGui::MemFree(format);
    ...
    void renderBody() { ImGui::SliderFloat(label, v, v_min, v_max, format, power); }
    char* label;
    float* v;
    float v_min;
    float v_max;
...
public:
    InputInt4() : label(NULL), v{0}, flags(0) {}
    virtual ~InputInt4() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() { ImGui::InputInt4(label, v, flags); }
    char* label;
    int v[4];
    ImGuiInputTextFlags flags;
};
...
public:
    DragInt() : label(NULL), v(0), v_speed(1.0f), v_min(0), v_max(0), format(ImStrdup("%d")) {}
    virtual ~DragInt() {
        if (label != NULL) ImGui::MemFree(label);
        if (format != NULL) ImGui::MemFree(format);
    }

    void renderBody() { ImGui::DragInt(label, &v, v_speed, v_min, v_max, format); }
    char* label;
    int v;
    float v_speed;
    int v_min;
...
public:
    DragIntRange2() : label(NULL), v_current_min(0), v_current_max(0), v_speed(1.0f), v_min(0), v_max(0), format(ImStrdup("%d")), format_max(NULL) {}
    ...
    void renderBody() { ImGui::DragIntRange2(label, &v_current_min, &v_current_max, v_speed, v_min, v_max, format, format_max); }
    char* label;
    int v_current_min;
    int v_current_max;
    float v_speed;
...
public:
    CollapsingHeader() : label(NULL), flags(0) {}
    virtual ~CollapsingHeader() {
        if (label != NULL) ImGui::MemFree(label);
    }

    void renderBody() {
        if (ImGui::CollapsingHeader(label, flags)) ContainerElement::renderBody();
    }
    char* label;
...
static ElementFactory* createElementFactory() {
    ...
    factory.element<InputInt3>("input-int3").text(&InputInt3::label, true).attribute("v", &InputInt3::v, true).attribute("flags", &InputInt3::flags);
    ...
    factory.element<Menu>("menu").attribute("label", &Menu::label, true).attribute("enabled", &Menu::enabled);
    ...
    factory.element<Window>("window").attribute("name", &Window::name, true).attribute("p-open", &Window::p_open).attribute("flags", &Window::flags);
    ...
    factory.element<InputFloat3>("input-float3").text(&InputFloat3::label).attribute("v", &InputFloat3::v).attribute("format", &InputFloat3::format).attribute("flags", &InputFloat3::flags);

    factory.element<InvisibleButton>("invisible-button").attribute("str-id", &InvisibleButton::str_id, true);

    factory.element<Combo>("combo").attribute("label", &Combo::label, true).attribute("preview-value", &Combo::preview_value).attribute("flags", &Combo::flags);

    factory.element<MenuItem>("menu-item").text(&MenuItem::label).attribute("shortcut", &MenuItem::shortcut).attribute("selected", &MenuItem::selected).attribute("enabled", &MenuItem::enabled);
    ...
    factory.element<Popup>("popup").attribute("str-id", &Popup::str_id).attribute("flags", &Popup::flags);
    ...
    factory.element<ChildFrame>("child-frame").attribute("id", &ChildFrame::id, true).attribute("flags", &ChildFrame::flags);
    ...
    factory.element<Selectable>("selectable").text(&Selectable::label).attribute("selected", &Selectable::selected).attribute("flags", &Selectable::flags);

    factory.element<DragDropTarget>("drag-drop-target");

    factory.element<ColorEdit3>("color-edit3").text(&ColorEdit3::label, true).attribute("col", &ColorEdit3::col, true).attribute("flags", &ColorEdit3::flags);

    factory.element<NextColumn>("next-column");

    factory.element<ColorEdit4>("color-edit4").text(&ColorEdit4::label, true).attribute("col", &ColorEdit4::col, true).attribute("flags", &ColorEdit4::flags);

    factory.element<SmallButton>("small-button").text(&SmallButton::label, true);

    factory.element<Child>("child").attribute("str-id", &Child::str_id, true).attribute("border", &Child::border).attribute("flags", &Child::flags);

    factory.element<DragDropSource>("drag-drop-source").attribute("flags", &DragDropSource::flags);

    factory.element<PopupContextItem>("popup-context-item").attribute("str-id", &PopupContextItem::str_id).attribute("mouse-button", &PopupContextItem::mouse_button);
    ...
    factory.element<TabItem>("tab-item").attribute("label", &TabItem::label, true).attribute("p-open", &TabItem::p_open).attribute("flags", &TabItem::flags);

    factory.element<TabBar>("tab-bar").attribute("str-id", &TabBar::str_id, true).attribute("flags", &TabBar::flags);

    factory.element<Dummy>("dummy");

    factory.element<Unindent>("unindent").attribute("indent-w", &Unindent::indent_w);

    factory.element<Indent>("indent").attribute("indent-w", &Indent::indent_w);

    factory.element<Bullet>("bullet");

    factory.element<Button>("button").text(&Button::label, true);

    factory.element<InputFloat2>("input-float2").text(&InputFloat2::label).attribute("v", &InputFloat2::v).attribute("format", &InputFloat2::format).attribute("flags", &InputFloat2::flags);
    ...
    factory.element<RadioButton>("radio-button").text(&RadioButton::label, true).attribute("active", &RadioButton::active);

    factory.element<Checkbox>("checkbox").text(&Checkbox::label, true).attribute("v", &Checkbox::v);
    ...
    factory.element<PopupModal>("popup-modal").attribute("name", &PopupModal::name, true).attribute("p-open", &PopupModal::p_open).attribute("flags", &PopupModal::flags);
    ...
    factory.element<PopupContextVoid>("popup-context-void").attribute("str-id", &PopupContextVoid::str_id).attribute("mouse-button", &PopupContextVoid::mouse_button);

    factory.element<Columns>("columns").attribute("count", &Columns::count).attribute("id", &Columns::id).attribute("border", &Columns::border);

    factory.element<ColorButton>("color-button").attribute("desc-id", &ColorButton::desc_id, true).attribute("col", &ColorButton::col, true).attribute("flags", &ColorButton::flags);
    ...
    factory.element<TextUnformatted>("text-unformatted").text(&TextUnformatted::text).attribute("text-end", &TextUnformatted::text_end);

    factory.element<InputInt2>("input-int2").text(&InputInt2::label, true).attribute("v", &InputInt2::v, true).attribute("flags", &InputInt2::flags);
    ...
    factory.element<ColorPicker3>("color-picker3").text(&ColorPicker3::label).attribute("col", &ColorPicker3::col, true).attribute("flags", &ColorPicker3::flags);
    ...
    factory.element<ProgressBar>("progress-bar").attribute("fraction", &ProgressBar::fraction).attribute("overlay", &ProgressBar::overlay);
    ...
    factory.element<SameLine>("same-line").attribute("offset-from-start-x", &SameLine::offset_from_start_x).attribute("spacing", &SameLine::spacing);

    factory.element<InputFloat4>("input-float4").text(&InputFloat4::label).attribute("v", &InputFloat4::v).attribute("format", &InputFloat4::format).attribute("flags", &InputFloat4::flags);
    ...
    factory.element<ArrowButton>("arrow-button").attribute("str-id", &ArrowButton::str_id, true).attribute("dir", &ArrowButton::dir, true);
    ...
    factory.element<InputInt4>("input-int4").text(&InputInt4::label, true).attribute("v", &InputInt4::v, true).attribute("flags", &InputInt4::flags);
    ...
    factory.element<Text>(TEXT_NODE).text(&Text::setText, true);

    factory.element<CollapsingHeader>("collapsing-header").attribute("label", &CollapsingHeader::label).attribute("flags", &CollapsingHeader::flags);
