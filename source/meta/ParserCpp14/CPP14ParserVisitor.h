...
public:
   ...
   */
    ...
    virtual std::any visitProSimpleTypeSpecifier(CPP14Parser::ProSimpleTypeSpecifierContext *context) = 0;

    virtual std::any visitNonSimpleTypeDeclSpecifier(CPP14Parser::NonSimpleTypeDeclSpecifierContext *context) = 0;

    virtual std::any visitPreDeclSpecifierSeq(CPP14Parser::PreDeclSpecifierSeqContext *context) = 0;

    virtual std::any visitPostDeclSpecifierSeq(CPP14Parser::PostDeclSpecifierSeqContext *context) = 0;

    virtual std::any visitProDeclSpecifierSeq(CPP14Parser::ProDeclSpecifierSeqContext *context) = 0;
    ...
    virtual std::any visitBaseSpecifierX(CPP14Parser::BaseSpecifierXContext *context) = 0;
