...
public:
  ...
  virtual std::any visitProSimpleTypeSpecifier(CPP14Parser::ProSimpleTypeSpecifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitNonSimpleTypeDeclSpecifier(CPP14Parser::NonSimpleTypeDeclSpecifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitPreDeclSpecifierSeq(CPP14Parser::PreDeclSpecifierSeqContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitPostDeclSpecifierSeq(CPP14Parser::PostDeclSpecifierSeqContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitProDeclSpecifierSeq(CPP14Parser::ProDeclSpecifierSeqContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitBaseSpecifierX(CPP14Parser::BaseSpecifierXContext *ctx) override {
    return visitChildren(ctx);
  }
