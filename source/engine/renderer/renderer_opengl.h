...
void row_upload_texture(const unsigned char *pixels, MErect update_rect, Uint32 format, int alignment, unsigned int pitch, int bytes_per_pixel);
void copy_upload_texture(const unsigned char *pixels, MErect update_rect, Uint32 format, int alignment, unsigned int pitch, int bytes_per_pixel);
