...
#if !defined(ME_SOUND_H)

#define ME_SOUND_FORCE_SDL
...
typedef enum cs_error_t {
    ME_SOUND_ERROR_NONE,
    ME_SOUND_ERROR_IMPLEMENTATION_ERROR_PLEASE_REPORT_THIS_ON_GITHUB,  // https://github.com/RandyGaul/cute_headers/issues
    ME_SOUND_ERROR_FILE_NOT_FOUND,
    ME_SOUND_ERROR_INVALID_SOUND,
    ME_SOUND_ERROR_HWND_IS_NULL,
    ME_SOUND_ERROR_DIRECTSOUND_CREATE_FAILED,
    ME_SOUND_ERROR_CREATESOUNDBUFFER_FAILED,
    ME_SOUND_ERROR_SETFORMAT_FAILED,
    ME_SOUND_ERROR_AUDIOCOMPONENTFINDNEXT_FAILED,
    ME_SOUND_ERROR_AUDIOCOMPONENTINSTANCENEW_FAILED,
    ME_SOUND_ERROR_FAILED_TO_SET_STREAM_FORMAT,
    ME_SOUND_ERROR_FAILED_TO_SET_RENDER_CALLBACK,
    ME_SOUND_ERROR_AUDIOUNITINITIALIZE_FAILED,
    ME_SOUND_ERROR_AUDIOUNITSTART_FAILED,
    ME_SOUND_ERROR_CANT_OPEN_AUDIO_DEVICE,
    ME_SOUND_ERROR_CANT_INIT_SDL_AUDIO,
    ME_SOUND_ERROR_THE_FILE_IS_NOT_A_WAV_FILE,
    ME_SOUND_ERROR_WAV_FILE_FORMAT_CHUNK_NOT_FOUND,
    ME_SOUND_ERROR_WAV_DATA_CHUNK_NOT_FOUND,
    ME_SOUND_ERROR_ONLY_PCM_WAV_FILES_ARE_SUPPORTED,
    ME_SOUND_ERROR_WAV_ONLY_MONO_OR_STEREO_IS_SUPPORTED,
    ME_SOUND_ERROR_WAV_ONLY_16_BITS_PER_SAMPLE_SUPPORTED,
    ME_SOUND_ERROR_CANNOT_SWITCH_MUSIC_WHILE_PAUSED,
    ME_SOUND_ERROR_CANNOT_CROSSFADE_WHILE_MUSIC_IS_PAUSED,
    ME_SOUND_ERROR_CANNOT_FADEOUT_WHILE_MUSIC_IS_PAUSED,
    ME_SOUND_ERROR_TRIED_TO_SET_SAMPLE_INDEX_BEYOND_THE_AUDIO_SOURCES_SAMPLE_COUNT,
    ME_SOUND_ERROR_STB_VORBIS_DECODE_FAILED,
    ME_SOUND_ERROR_OGG_UNSUPPORTED_CHANNEL_COUNT,
} cs_error_t;
...
#if defined(SDL_rwops_h_) && defined(ME_SOUND_SDL_RWOPS)
