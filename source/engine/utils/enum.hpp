...
#define ENUM_HPP_GENERATE_VALUES_OP(Enum, i, x) ((::ME::cpp::detail::ignore_assign<Enum>)Enum::x).value,
...
#define ENUM_HPP_GENERATE_NAMES_OP(d, i, x) ::ME::cpp::detail::trim_raw_name(ENUM_HPP_PP_STRINGIZE(x)),
...
#define ENUM_HPP_TRAITS_DECL(Enum, Fields)                                                                                                \
    ...
    public:                                                                                                                               \
        ...
        [[maybe_unused]] static constexpr std::string_view to_string_or_empty(enum_type e) noexcept {                                     \
            ...
            return ::ME::cpp::empty_string;                                                                                               \
        }                                                                                                                                 \
        [[maybe_unused]] static std::string_view to_string_or_throw(enum_type e) {                                                        \
            if (auto s = to_string(e)) {                                                                                                  \
                return *s;                                                                                                                \
            }                                                                                                                             \
            ::ME::cpp::detail::throw_exception_with(#Enum "_traits::to_string_or_throw(): invalid argument");                             \
        }                                                                                                                                 \
        ...
        [[maybe_unused]] static enum_type from_string_or_throw(std::string_view name) {                                                   \
            ...
            ::ME::cpp::detail::throw_exception_with(#Enum "_traits::from_string_or_throw(): invalid argument");                           \
        }                                                                                                                                 \
        ...
        [[maybe_unused]] static constexpr std::size_t to_index_or_invalid(enum_type e) noexcept {                                         \
            ...
            return ::ME::cpp::invalid_index;                                                                                              \
        }                                                                                                                                 \
        [[maybe_unused]] static std::size_t to_index_or_throw(enum_type e) {                                                              \
            if (auto i = to_index(e)) {                                                                                                   \
                return *i;                                                                                                                \
            }                                                                                                                             \
            ::ME::cpp::detail::throw_exception_with(#Enum "_traits::to_index_or_throw(): invalid argument");                              \
        }                                                                                                                                 \
        ...
        [[maybe_unused]] static enum_type from_index_or_throw(std::size_t index) {                                                        \
            ...
            ::ME::cpp::detail::throw_exception_with(#Enum "_traits::from_index_or_throw(): invalid argument");                            \
        }                                                                                                                                 \
    }
...
namespace std {
template <typename Enum>
struct hash<ME::cpp::bitflags::bitflags<Enum>> {
    size_t operator()(ME::cpp::bitflags::bitflags<Enum> bf) const noexcept { return hash<Enum>{}(bf.as_enum()); }
};
}  // namespace std
...
#define ENUM_HPP_OPERATORS_DECL(Enum)                                                                                                                                                  \
    constexpr ::ME::cpp::bitflags::bitflags<Enum> operator~[[maybe_unused]] (Enum l) noexcept { return ~::ME::cpp::bitflags::bitflags(l); }                                            \
    constexpr ::ME::cpp::bitflags::bitflags<Enum> operator| [[maybe_unused]] (Enum l, Enum r) noexcept { return ::ME::cpp::bitflags::bitflags(l) | ::ME::cpp::bitflags::bitflags(r); } \
    constexpr ::ME::cpp::bitflags::bitflags<Enum> operator& [[maybe_unused]] (Enum l, Enum r) noexcept { return ::ME::cpp::bitflags::bitflags(l) & ::ME::cpp::bitflags::bitflags(r); } \
    constexpr ::ME::cpp::bitflags::bitflags<Enum> operator^ [[maybe_unused]] (Enum l, Enum r) noexcept { return ::ME::cpp::bitflags::bitflags(l) ^ ::ME::cpp::bitflags::bitflags(r); }
