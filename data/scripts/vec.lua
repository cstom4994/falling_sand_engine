...
function vec2:get() return self.x, self.y end

function vec2:sqrMagnitude() return self.x * self.x + self.y * self.y end
...
function vec2.dot(lhs, rhs) return lhs.x * rhs.x + lhs.y * rhs.y end
...
vec2.__add = function(va, d) return vec2.new(va.x + d.x, va.y + d.y) end

vec2.__sub = function(va, d) return vec2.new(va.x - d.x, va.y - d.y) end

vec2.__unm = function(va) return vec2.new(-va.x, -va.y) end

vec2.__eq = function(va, d) return va.x == d.x and va.y == d.y end
...
function vec3:get() return self.x, self.y, self.z end
...
function vec3.dot(lhs, rhs) return lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z end
...
function vec3:glm() return glmvec2(self.x, self.y, self.z) end
...
function vec4:get() return self.x, self.y, self.z, self.w end

function vec4:sqrMagnitude()
    return self.x * self.x + self.y * self.y + self.z * self.z + self.w * self.w
end

function vec4:clone() return vec4.new(self.x, self.y, self.z, self.w) end
...
function vec4:glm() return glmvec2(self.x, self.y, self.z, self.w) end
...
vec4.__unm = function(va) return vec4.new(-va.x, -va.y, -va.z, -va.w) end
